...
<body class="home-page">
        ...
        <div class="features-grid">
            <div class="feature-card">
                <div class="feature-icon" style="background: #ff8a00;">
                    <img src="{{ asset('assets/images/icons/badge 1.svg') }}" alt="Great Deals"
                        style="width:36px;height:36px;object-fit:contain;">
                </div>
                <div>
                    <h4>Great Deals for you</h4>
                    <p>Get some great deals and discounts on courses. Avail Now. Happy teaching and learning, everyone!
                    </p>
                </div>
            </div>
            <div class="feature-card">
                <div class="feature-icon" style="background: #93c5fd;">
                    <img src="{{ asset('assets/images/icons/video streaming 1.svg') }}" alt="Audio & Video"
                        style="width:36px;height:36px;object-fit:contain;">
                </div>
                <div>
                    <h4>Audio &amp; Video</h4>
                    <p>High-quality audio and video courses make it easy to learn and teach new skills. Get started
                        right away!</p>
                </div>
            </div>
            <div class="feature-card">
                <div class="feature-icon" style="background: #34d399;">
                    <img src="{{ asset('assets/images/icons/video call 1.svg') }}" alt="Virtual Classroom"
                        style="width:36px;height:36px;object-fit:contain;">
                </div>
                <div>
                    <h4>Virtual Classroom</h4>
                    <p>Tutor simulates a physical learning environment with interactive learning that allows instructors
                        and students to engage with one another.</p>
                </div>
            </div>
            <div class="feature-card">
                <div class="feature-icon" style="background: #0d9488;">
                    <img src="{{ asset('assets/images/icons/study 1.svg') }}" alt="Group learning"
                        style="width:36px;height:36px;object-fit:contain;">
                </div>
                <div>
                    <h4>Group learning</h4>
                    <p>Put your heads together and increase your knowledge base. With the right platform, transform your
                        course into an interactive group experience.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="wide-range-left">
                ...
                <div class="wide-range-images-custom">
                    ...
                    <div class="wr-img-block wr-img-1">
                        <img src="{{ asset('assets/images/learning.png') }}" alt="Learning Robotics">
                    </div>
                    <!-- Boy Image (Staggered) -->
                    <div class="wr-img-block wr-img-2">
                        <img src="{{ asset('assets/images/testing1.png') }}" alt="Deep Focus">
                    </div>
                </div>
            </div>
            ...
            <div class="wide-range-right">
                <div class="category-cards-grid">
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="{{ asset('assets/images/icons/007-vectors 1.svg') }}" alt="Modern Art & Ideas">
                        </div>
                        <div class="cat-text">
                            <h5>Modern</h5>
                            <p>Art &amp; Ideas</p>
                    ...
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="{{ asset('assets/images/icons/Group.svg') }}" alt="Ignite Your Everyday Creativity">
                        </div>
                        <div class="cat-text">
                            <h5>Ignite Your</h5>
                    ...
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="{{ asset('assets/images/icons/science 1 (1).svg') }}" alt="Electrodynamics">
                        </div>
                        <div class="cat-text">
                    ...
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="{{ asset('assets/images/icons/Group (1).svg') }}" alt="Postwar Abstract Painting">
                        </div>
                        <div class="cat-text">
                            <h5>Postwar</h5>
                ...
                <ul class="wr-points">
                    <li>Find the top course that fits you from a wide range of online topics available with new
                        additions published frequently and expand your career opportunities.</li>
    ...
    <section class="career-section">
        <div class="career-inner">
            ...
            <div class="live-classes-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px;">
                @for($i = 0; $i < 3; $i++) <div class="free-session-card">
                    <div class="free-session-thumb">
                        <img src="{{ asset('assets/images/learning.png') }}" alt="Live Class">
                    </div>
    ...
    <section class="course-section" style="background: white;">
        <div class="course-section-header">
            <div>
                <h2 class="section-heading" style="font-size: 24px; margin-bottom: 8px;">Pick a free session
                    course<br>to get started</h2>
                <p class="section-sub">Once you done with your free videos, for continue you have to subscribe the
                    course</p>
            </div>
        ...
        <div class="course-cards-row"
            ...
            @for($i = 0; $i < 4; $i++) <a href="{{ route('dashboard.1') }}" class="vertical-course-card"
                ...
                <div class="vertical-card-body">
                    ...
                    <p class="vertical-card-desc">Topic Description Lorem ipsum<br>dolor sit amet, consectetur adip..
                    </p>
