...
<head>
    ...
    <title>{{ __('lms_ui::course_flow.title_courses') }}</title>
    ...
    <div class="shared-shell">
            ...
            <div class="tab-panels">
                <div class="pane active" id="pane-outcomes">
                    <div class="outcomes-content">
                        <h2>{{ __('lms_ui::course_outcomes.heading') }}</h2>
                        <div style="font-size: 14px; color: #475569; line-height: 1.8;">
                            <p><strong>{{ __('lms_ui::course_outcomes.clo1_title') }}</strong> {{ __('lms_ui::course_outcomes.clo1_body') }}</p>
                            <p><strong>{{ __('lms_ui::course_outcomes.clo2_title') }}</strong> {{ __('lms_ui::course_outcomes.clo2_body') }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer>
            <div class="footer-inner">
                <div class="f-brand">
                    <div class="f-logo-wrap"><img src="{{ asset('lms-ui/images/icons/logo.svg') }}" alt="Logo"></div>
