                                    ...
                                    <form action="<?php echo e(route('enrollmentCancellationSubmit')); ?>" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-25">
                                                <label class="primary_input_label" for="course"><?php echo e(__('courses.Course')); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label"
                                                           for=""><?php echo e(__('frontend.Reason')); ?></label>
                                            ...
                                            <div class="col-lg-12 mb-30">
                                                ...
                                                <button class="primary-btn semi_large2  fix-gr-bg"
                                                        ...
                                                        type="submit">  <?php echo e(__('common.Submit')); ?>
                ...
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('frontend.Refund & Cancellation')); ?> <?php echo e(__('common.History')); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
...
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\backend\my_panel\my_refund\index.blade.php ENDPATH**/ ?>