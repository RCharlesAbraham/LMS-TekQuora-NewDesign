            ...
            <div class="login_wrapper_content">
                ...
                <form action="<?php echo e(route('register')); ?>" method="POST" id="regForm">
                    ...
                    <div class="row">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isModuleActive('Organization')): ?>
                            <div class="col-12 mt_20">
                                <label><?php echo e(trans('organization.account_type')); ?></label>
                                <ul class="quiz_select d-flex">
                                    <li>
                                        <label
                                            ...
                                            <span
                                                class="label_name"><?php echo e(__('common.Student')); ?> </span>
                                        </label>
                                    </li>
                                    ...
                                    <li class="ms-3">
                                        <label
                                            ...
                                            <span
                                                class="checkmark mr_10"></span>
                                            <span
                                                class="label_name"><?php echo e(__('organization.Organization')); ?> </span>
                                        </label>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($custom_field->show_dob): ?>
                            <div class="col-12 mt_20">
                                <div class="input-group custom_group_field">
                                    <label for="dob"><?php echo e(__('common.Date of Birth')); ?> : </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7">
                                            <select class="small_select w-100"
                                                ...
                                                <option value="personal"><?php echo e(__('common.Personal')); ?></option>
                                                <option value="corporate"><?php echo e(__('common.Corporate')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="remember_forgot_passs d-flex align-items-center">
                                <label class="primary_checkbox d-flex" for="checkbox">
                                    ...
                                    <p><?php echo e(__('frontend.By signing up, you agree to')); ?> <a target="_blank"
                                                                                         href="<?php echo e(url('terms')); ?>"><?php echo e(__('frontend.Terms of Service')); ?></a> <?php echo e(__('frontend.and')); ?>

                                        <a target="_blank"
                                           href="<?php echo e(url('privacy')); ?>"><?php echo e(__('frontend.Privacy Policy')); ?></a></p>
                                </label>
                        ...
                        <div class="col-12 mt_20">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(saasEnv('NOCAPTCHA_FOR_REG')=='true'): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->has('g-recaptcha-response')): ?>
                                    <span class="text-danger"
                                          role="alert"><?php echo e($errors->first('g-recaptcha-response')); ?></span>s
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
...
<?php echo $__env->make(theme('auth.layouts.app'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\auth\register.blade.php ENDPATH**/ ?>