...
<head>
    ...
    <title>{{ __('lms_ui::learning.page_title') }}</title>
...
<body>
    ...
    <div class="shared-shell">
        ...
        <main class="content">
            <h2 class="page-title">{{ __('lms_ui::learning.page_heading') }}</h2>
            
            <div class="main-card">
                <div class="tabs">
                    <div class="tab active">{{ __('lms_ui::learning.tab_ongoing') }}</div>
                    <div class="tab">{{ __('lms_ui::learning.tab_completed') }}</div>
                </div>
                    ...
                    <a href="{{ route('learning.p2') }}" style="text-decoration: none; color: inherit;">
                        <div class="course-wrap">
                            <div class="course-card">
                                ...
                                <div class="cc-img" style="background-image: url('{{ asset('assets/images/math_bg.png') }}');"></div>
                    ...
                    <a href="{{ $card['href'] }}" style="text-decoration: none; color: inherit;">
                        <div class="course-wrap">
                            <div class="course-card">
                                ...
                                <div class="cc-img" style="background-image: url('{{ asset('assets/images/' . $card['img']) }}');"></div>
                                <div class="cc-badge">{{ __('lms_ui::learning.task_badge') }}</div>
        ...
        <footer>
            <div class="f-brand">
                <div class="f-logo-circle"><img src="{{ asset('assets/images/icons/logo.svg') }}" alt="Logo"></div>
