        ...
        <div class="billing_details_wrapper">
            <div class="biling_address gray-bg">
                <div class="biling-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('ebookPlanCheckout', ['plan'=>$plan->id, 'type'=>'edit'])); ?>"><?php echo e(__('common.Edit')); ?></a>
                </div>
                                            ...
                                            <div class="payment_method_single">
                                                <div class="deposite_payment_wrapper customer_payment_wrapper">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gateway->method == 'Stripe'): ?>
                                                        <form action="<?php echo e(route('ebookPlanPaymentSubmit')); ?>"
                                                              method="post">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLabel">
                                                                            <?php echo e(__('membership.Ebook Plan Submit')); ?></h5>
                                                                    </div>
                                                                    <form
                                                                        action="<?php echo e(route('ebookPlanPaymentSubmit')); ?>"
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\ebook-payment-page-section.blade.php ENDPATH**/ ?>