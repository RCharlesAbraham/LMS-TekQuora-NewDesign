...
<head>
    ...
    <title>{{ __('lms_ui::course_flow.title_testimonials') }}</title>
    ...
    <style>
        ...
        .t-avatar { width: 44px; height: 44px; border-radius: 50%; background: #f1f5f9 url('{{ asset('lms-ui/images/logo.png') }}') no-repeat center; background-size: contain; border: 1.5px solid #e2e8f0; }
        ...
        .hero-right .video-preview {     border: 1px solid #94a3b8;width: 100%; aspect-ratio: 1.6; background: url('{{ asset('lms-ui/images/9. Animal care.jpg') }}') center/cover no-repeat; border-radius: 20px; position: relative; display: flex; align-items: center; justify-content: center; }
...
<body>
    ...
    <div class="shared-shell">
        @include('lms-ui.partials.sidebar', ['activePage' => 'courses'])
        ...
        <main class="main-card">
            <div class="course-hero">
                <div class="hero-left">
                    ...
                    <div class="hero-btns">
                        <button type="button" class="btn-dark-blue" style="background: #002b55;">{{ __('lms_ui::course_flow.add_to_cart') }}</button>
                    </div>
                </div>
            ...
            <div class="tab-strip">
                ...
                <div class="tab-item active">{{ __('lms_ui::course_flow.tab_testimonials') }}</div>
                <a href="{{ route('lms.reviews') }}" class="tab-item">{{ __('lms_ui::course_flow.tab_reviews') }}</a>
            </div>

           

            <div class="testi-grid" style="min-height: 200px; display: flex; align-items: center; justify-content: center; color: #94a3b8; font-size: 14px;">
        ...
        <footer style="grid-column: 1 / -1; border-radius: 26px; background: #fff; padding: 60px 40px; border-top: 1px solid #f1f5f9; display: flex; justify-content: center; width: 100%; margin-top: 10px; box-sizing: border-box;">
            <div class="footer-inner">
                <div class="f-brand">
                    <div class="f-logo-circle"><img src="{{ asset('lms-ui/images/icons/logo.svg') }}"></div>
                ...
                <div class="f-right-col">
                    <form method="POST" id="testi-footer-lang" action="{{ route('lms.locale.set', ['locale' => app()->getLocale()]) }}" style="display:inline;">
                        @csrf
                        <select class="lang-picker" onchange="document.getElementById('testi-footer-lang').action='{{ url('/set-language') }}/'+this.value; document.getElementById('testi-footer-lang').submit();">
