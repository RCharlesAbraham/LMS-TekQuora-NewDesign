                ...
                <div>
                    ...
                    <div class="pm-card">
                        <div class="pm-option active" onclick="selectPM(this)">
                            <img src="{{ asset('assets/images/icons/logos_stripe.png') }}" alt="Stripe">
                            <span>Stripe</span>
                        </div>
                        <div class="pm-option" onclick="selectPM(this)">
                            <img src="{{ asset('assets/images/icons/logos_paypal (1).png') }}" alt="Paypal">
                            <span>Paypal</span>
                        </div>
                ...
                <div class="footer-inner">
                    <div class="footer-logo-section">
                        <div class="logo-circle">
                            <img src="{{ asset('assets/images/logo.png') }}" alt="IL2" style="height: 35px;">
                        </div>
