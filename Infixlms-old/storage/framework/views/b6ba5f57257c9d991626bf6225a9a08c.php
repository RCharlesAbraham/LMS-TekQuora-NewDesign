<div>
    <form action="<?php echo e(route('membershipPlanPayment')); ?>" id="orderFrom" method="post">
        <?php echo csrf_field(); ?>
        ...
        <div class="checkout_wrapper" id="mainFormData">
            ...
            <div class="billing_details_wrapper">
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <input type="hidden" name="plan_id" value="<?php echo e($cart->plan_id); ?>">
                ...
                <table class="table table-bordered billing_info" style=" <?php if(count($bills) == 0): ?> display: none <?php endif; ?>">
                    ...
                    <tr>
                        ...
                        <td class="billing_city"><?php echo e(isset($bills[0]->city)?$bills[0]->city:''); ?></td>
                    </tr>
                    <tr>
                        <td><?php echo e(__('frontend.Country')); ?></td>
                        <td class="billing_country"><?php echo e(isset($bills[0]->country)?$bills[0]->country:''); ?></td>
                    </tr>
                    <tr>
            ...
            <div class="order_wrapper">
                ...
                <div class="ordered_products">
                    ...
                    <div class="single_ordered_product">
                        ...
                        <span class="order_prise f_w_500 font_16">
                           <?php echo e(@$cart->plan->expire); ?> [<?php echo e(@$cart->plan->expire_type); ?>]
                            </span>
                    </div>
                ...
                <div class="ordered_products_lists">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(hasTax()): ?>
                        <div class="single_lists">
                            ...
                            <span class="totalTax"><?php echo e(getPriceFormat(taxAmount($cart->plan->price))); ?></span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\membership-plan-checkout-page-section.blade.php ENDPATH**/ ?>