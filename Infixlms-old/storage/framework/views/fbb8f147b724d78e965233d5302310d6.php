                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($methods)): ?>
                                            ...
                                            <div class="payment_method_single">
                                                <div
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gateway->method=="Stripe"): ?>
                                                        <form
                                                            action="<?php echo e(route('saasSubmit')); ?>"
                                                            method="post">
                                        ...
                                        margin-top: -9px;"
                                                            ...
                                                            <script
                                                                ...
                                                                class="stripe-button"
                                                                data-key="<?php echo e(getMainPaymentEnv('STRIPE_KEY')); ?>"
                                                            ...
                                                            <input
                                                                value="<?php echo e(convertCurrency(Settings('currency_code') ??'BDT', 'USD', $plan->price)); ?>"
                                                                readonly="readonly"
                                                                type="hidden"
                                                                id="amount"
                                                                name="amount">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <form
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value="Wallet"
                                                                            id="balanceInput"
                                                                            style="display: <?php echo e(Auth::user()->balance >=$plan->price?'':'none'); ?>"
                                                                            class="method"
                                                                            type="hidden">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <input
                                                                                        ...
                                                                                        name="amount"
                                                                                        class="primary_input3"
                                                                                        value="<?php echo e(getPriceFormat($plan->price)); ?>"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->balance >= $plan->price): ?>
                                                                                <button
                                                                                    class=" theme_btn"
                                                                                    type="submit">
                                        ...
                                        margin-top: -2px;"
                                                                    ...
                                                                    <script
                                                                        ...
                                                                        data-key="<?php echo e(getMainPaymentEnv('RAZOR_KEY')); ?>"
                                                                        data-amount="<?php echo e(convertCurrency(Settings('currency_code') ??'BDT', 'INR', $plan->price)*100); ?>"
        ...
        <div class="order_wrapper">
            ...
            <div class="ordered_products">
                ...
                <div class="single_ordered_product">
                    ...
                    <span class="order_prise f_w_500 font_16">
                           <?php echo e(@$cart->plan->days); ?> Days
                            </span>
                </div>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\saas-payment-page-section.blade.php ENDPATH**/ ?>