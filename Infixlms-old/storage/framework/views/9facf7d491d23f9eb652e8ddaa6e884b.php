...
<?php $__env->startSection('mainContent'); ?>
    ...
    <div class="course_fullview_wrapper">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($class->host == 'Youtube'): ?>
            <?php
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Settings('youtube_default_player')): ?>
                ...
                <?php $__env->startPush('js'); ?>
                    ...
                    <script>
                        ...
                        //         classAutoComplete(course_id,<?php echo e(showPicName(Request::url())); ?>);
                        //     }
                        // });
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($class->host == 'Vimeo'): ?>
            <div class="video_wrapper">
                <iframe class="video_iframe" id="video-id"
                        src="https://player.vimeo.com/video/<?php echo e(getVideoId(showPicName(@$class->link))); ?>?autoplay=1&"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($class->host == 'Self'): ?>
            <video class="" id="video-id" controls autoplay>
                <source src="<?php echo e(asset($class->link)); ?>" type="video/mp4"/>
                <source src="<?php echo e(asset($class->link)); ?>" type="video/ogg">
            </video>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>



        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($class->host == 'URL'): ?>
            <video class="" id="video-id" controls autoplay
                   onended="classAutoComplete(course_id, <?php echo e(showPicName(Request::url())); ?>)">
                <source src="<?php echo e($class->link); ?>" type="video/mp4">
                <source src="<?php echo e($class->link); ?>" type="video/ogg">
        ...
        <div class="floating-title position-fixed">
            <p class="font_16 d-flex align-items-center">
                <span class="header__common_btn me-2 play_toggle_btn"><i
                        class="ti-menu-alt"></i></span> <?php echo e(__('chat.chat')); ?>
        ...
        <div class="course__play_warp courseListPlayer ">
            ...
            <div class="agora-chat d-flex flex-column h-100">
                ...
                <div id="chatView" class="agora-chat-box pb-30">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="user-card">
                            <div class="avatar">
                                <img src="<?php echo e(getProfileImage($message->user->image, $message->user->name)); ?>" alt=""
                                     class="img-cover rounded-circle">
                            </div>
                            <div class="user-card-content">
                                <div class="user-card-wraper">
                                    <span><?php echo e($message->user->name); ?></span>
                                    <p class="mb-0"><?php echo e($message->msg); ?></p>
                                </div>
                                <div class="user-send-date"><?php echo e($message->created_at->format('Y-m-d H:i:s')); ?></div>
                            </div>
                        </div>
            ...
            <textarea name="message" id="messageInput" class="form-control " rows="3"
                      placeholder="<?php echo e(trans('common.Type Your Message')); ?>"></textarea>
                    </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($class->host == 'Self' || $class->host == 'AmazonS3' || $class->host == 'URL'): ?>
        <script>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!Settings('show_seek_bar')): ?>
            <style>
    ...
    <script>
        ...
        channel.bind('new-class-message-<?php echo e($class->id); ?>', function (data) {
        ...
        $(document).on("click", "#sendMessage", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(url('custom/send-custom-class-message/' . $class->id)); ?>",
                type: "POST",
                data: {
                    'message': msg
                },
...
<?php echo $__env->make(theme('layouts.full_screen_master'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\pages\custom-class.blade.php ENDPATH**/ ?>