<div>
 ...
 <input type="hidden" id="today_date" value="<?php echo e(date('Y-m-d')); ?>">
            ...
            <div class="modal-content">
                <div class="modal_header d-flex align-items-center gap_15 ">
                    ...
                    <a href="#" class="link_icon" id="calendar_link">
                        <img src="<?php echo e(asset('Modules/Calendar/Resources/assets/img/link_icon.svg')); ?>" alt="">
                    </a>
                </div>
...
</div><?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\calendar-view.blade.php ENDPATH**/ ?>