...
<head>
    ...
    <title><?php echo e(__('lms_ui::course_flow.title_testimonials')); ?> - TekQuora</title>
        ...
        <main class="shared-content main-card" style="background: #fff; border-radius: 30px; padding: 40px; box-shadow: 0 4px 25px rgba(0,0,0,0.02);">
            <div class="course-hero">
                <div class="hero-left">
                    ...
                    <div class="hero-btns">
                        <button type="button" class="btn-dark-blue" style="background: #002b55;"><?php echo e(__('lms_ui::course_flow.add_to_cart')); ?></button>
                    </div>
                </div>
            ...
            <div class="tab-strip">
                ...
                <div class="tab-item active"><?php echo e(__('lms_ui::course_flow.tab_testimonials')); ?></div>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/testimonials.blade.php ENDPATH**/ ?>