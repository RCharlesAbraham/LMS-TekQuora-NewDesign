...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        /* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ MAIN SHELL Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
        .wrapper {
            width: 100%;
            max-width: 1600px;
            margin: 0 auto;
        ...
        /* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ COURSE CARD Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
        .course-card {
        ...
        /* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ ACTION AREA Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
    ...
    <div class="shared-shell">
        ...
        <main class="main-content">
            ...
            <div class="course-card">
                <div class="card-thumb">
                    <img src="{{ asset('assets/images/learning.png') }}" alt="Course Thumb">
                </div>
                <div class="card-info">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="stats-row">
                            ...
                            <div class="stat-item">Ã¢Â­Â 4.5</div>
        ...
        <footer>
            <div class="footer-inner">
                <div class="f-brand">
                    <div class="f-logo-wrap"><img src="{{ asset('assets/images/icons/logo.svg') }}" alt="Logo"></div>
