...
<head>
    ...
    <title><?php echo e(__('lms_ui::quiz.page_title')); ?></title>
...
<body>
    ...
    <div class="shared-shell">
        <?php echo $__env->make('partials.sidebar', ['activePage' => 'quiz'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="contest-grid">
                    <div class="contest-card">
                        <div class="contest-banner" style="background: linear-gradient(135deg, #6366f1 0%, #a855f7 100%);">
                            <img src="<?php echo e(asset('assets/images/learning.png')); ?>" alt="Technology Contest">
                        </div>
                    ...
                    <div class="contest-card">
                        <div class="contest-banner" style="background: linear-gradient(135deg, #facc15 0%, #f59e0b 100%);">
                            <img src="<?php echo e(asset('assets/images/learning.png')); ?>" alt="Trivia Quiz">
                        </div>
                        <div class="contest-body">
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/quiz.blade.php ENDPATH**/ ?>