<aside class="shared-sidebar">
    ...
    <a href="{{ route('certificate') }}" class="nav-link {{ request()->routeIs('certificate') ? 'active' : '' }}">
    ...
    <a href="{{ route('reward.points') }}" class="nav-link {{ request()->routeIs('reward.points') ? 'active' : '' }}">
    ...
    <a href="{{ route('account.new') }}" class="nav-link {{ request()->routeIs('account.new') ? 'active' : '' }}">
