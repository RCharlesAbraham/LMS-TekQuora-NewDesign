<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('hero-section', $hasDescription)): ?>
    <?php
        $decription = \Modules\Appointment\Entities\AppointmentFrontendPage::description('hero-section', 'appointment_page');
    ?>
        <?php echo $decription; ?>
<?php else: ?>
    <?php echo $__env->make(theme('snippets.components._appointment_hero_area'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <div class="tutor_category_inner">
                        <div class="tutor_category_grid">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href='<?php echo e(route('category.tutor', [convertToSlug($category->name.'-'.$category->id)])); ?>'
                                   class="tutor_category_item">
                                    ...
                                    <div>
                                        <h5><?php echo e($category->name); ?> <?php echo e(__('appointment.Tutor')); ?></h5>
                                        <p>

                                            <?php echo e($category->category_instructor_count); ?>
                        ...
                        <div class='tutor_category_inner_bottom'>
                            <a href="<?php echo e(asset('/appointment/tutor-finder')); ?>" class="theme_btn">
                                <?php echo e(__('appointment.View All Category')); ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('feature-01', $hasDescription)): ?>
    <?php
        $decription = \Modules\Appointment\Entities\AppointmentFrontendPage::description('feature-01', 'appointment_page');
    ?>
        <?php echo $decription; ?>
<?php else: ?>
    <?php echo $__env->make(theme('snippets.components._appointment_feature_01'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('feature-02', $hasDescription)): ?>
    <?php
        $decription = \Modules\Appointment\Entities\AppointmentFrontendPage::description('feature-02', 'appointment_page');
    ?>
        <?php echo $decription; ?>
<?php else: ?>
    <?php echo $__env->make(theme('snippets.components._appointment_feature_02'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('feature-03', $hasDescription)): ?>
    <?php
        $decription = \Modules\Appointment\Entities\AppointmentFrontendPage::description('feature-03', 'appointment_page');
    ?>
        <?php echo $decription; ?>
<?php else: ?>
    <?php echo $__env->make(theme('snippets.components._appointment_feature_03'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('feature-04', $hasDescription)): ?>
    <?php
        $decription = \Modules\Appointment\Entities\AppointmentFrontendPage::description('feature-04', 'appointment_page');
    ?>
        <?php echo $decription; ?>
<?php else: ?>
    <?php echo $__env->make(theme('snippets.components._appointment_feature_04'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('feature-05', $hasDescription)): ?>
    <?php
        $decription = \Modules\Appointment\Entities\AppointmentFrontendPage::description('feature-05', 'appointment_page');
    ?>
        <?php echo $decription; ?>
<?php else: ?>
    <?php echo $__env->make(theme('snippets.components._appointment_feature_05'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('feature-06', $hasDescription)): ?>
    <?php
        $decription = \Modules\Appointment\Entities\AppointmentFrontendPage::description('feature-06', 'appointment_page');
    ?>
        <?php echo $decription; ?>
<?php else: ?>
    <?php echo $__env->make(theme('snippets.components._appointment_feature_06'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('feature-07', $hasDescription)): ?>
    <?php
        $decription = \Modules\Appointment\Entities\AppointmentFrontendPage::description('feature-07', 'appointment_page');
    ?>
        <?php echo $decription; ?>
<?php else: ?>
    <?php echo $__env->make(theme('snippets.components._appointment_feature_07'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $sponsors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sponsor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href='#' class="sponsor_item">
                        <img src="<?php echo e(asset($sponsor->image)); ?>" alt="">
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\appointment.blade.php ENDPATH**/ ?>