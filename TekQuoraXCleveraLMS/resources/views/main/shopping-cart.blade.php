...
<head>
    ...
    <title>{{ __('lms_ui::cart.page_title') }}</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ CART ITEMS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
        ...
        /* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ SUMMARY CARD Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
        .summary-card {
            border: 1px solid #e2e8f0;
            border-radius: 16px;
            overflow: hidden;
    ...
    <div class="shared-shell">
        ...
        <main class="content">
            <div class="content-header">
                <h2>{{ __('lms_ui::cart.heading') }}</h2>
                <button type="button" class="btn-clear">{{ __('lms_ui::cart.clear_all') }}</button>
            </div>
            ...
            <div class="cart-grid">
                ...
                <div class="cart-list">
                    ...
                    <div class="cart-item-wrap">
                        ...
                        <div class="cart-item">
                            ...
                            <div class="item-info">
                                <div class="item-title">{{ __('lms_ui::cart.course_title') }}</div>
                                <div class="item-desc">{{ __('lms_ui::cart.course_desc') }}</div>
                                <div class="teacher-info">
                                    <div class="teacher-avatar"></div>
                                    <span class="teacher-name">{{ __('lms_ui::cart.created_by_teacher') }}</span>
                                </div>
                                <div class="item-actions">
                                    <button type="button" class="btn-save">{{ __('lms_ui::cart.saved_later') }}</button>
                                    <button type="button" class="btn-delete">{{ __('lms_ui::cart.delete') }}</button>
                                </div>
                            </div>
                            <div class="item-price">{{ __('lms_ui::cart.free') }}</div>
                        </div>
                    </div>
                ...
                <div class="summary-panel">
                    <div class="summary-card">
                        <div class="summary-header">{{ __('lms_ui::cart.payment_summary') }}</div>
                        <div class="summary-body">
                            <div class="summary-row">
                                <span class="row-label">{{ __('lms_ui::cart.subtotal') }}</span>
                                <span class="row-value">$0</span>
                            </div>
                            <div class="summary-row">
                                <span class="row-label">{{ __('lms_ui::cart.taxes') }}</span>
                                <span class="row-value">$0</span>
                            </div>
                        </div>
                        <div class="summary-total">
                            <span class="total-label">{{ __('lms_ui::cart.total') }}</span>
