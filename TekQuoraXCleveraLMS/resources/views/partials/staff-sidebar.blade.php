...
<aside class="staff-sidebar">
    ...
    <a href="{{ route('staff.dashboard') }}" class="nav-link {{ request()->routeIs('staff.dashboard') ? 'active' : '' }}">
        <img src="{{ asset('assets/images/icons/1.png') }}" style="width: 20px; height: 20px;" alt="">
        Dashboard
    </a>

    <div class="nav-dropdown">
        <a href="#" class="nav-link">
            <img src="{{ asset('assets/images/icons/9.png') }}" style="width: 20px; height: 20px;" alt="">
            SCORM
    ...
    <div class="sidebar-section">
        ...
        <div class="nav-dropdown">
            <a href="#" class="nav-link">
                <img src="{{ asset('assets/images/icons/4.png') }}" style="width: 20px; height: 20px;" alt="">
                Courses
                <span class="dropdown-arrow"></span>
            </a>
        </div>
        <div class="nav-dropdown">
            <a href="#" class="nav-link">
                <img src="{{ asset('assets/images/icons/5.png') }}" style="width: 20px; height: 20px;" alt="">
                Quiz
                <span class="dropdown-arrow"></span>
            </a>
        </div>
        ...
        <div class="nav-dropdown">
            <a href="#" class="nav-link">
                <img src="{{ asset('assets/images/icons/8.png') }}" style="width: 20px; height: 20px;" alt="">
                Report
                <span class="dropdown-arrow"></span>
            </a>
        </div>
