...
<head>
    ...
    <style>
        ...
        /* --- FOOTER --- */
        footer { border-radius: 26px; box-sizing: border-box; background: #fff; padding: 60px 40px; border-top: 1px solid #f1f5f9; display: flex; justify-content: center; width: 100%; margin-top: 40px; }
            ...
            <div class="main-card">
                ...
                <footer>
                    <div class="footer-inner">
                        <div class="f-brand">
                            <div class="f-logo-wrap"><img src="<?php echo e(asset('assets/images/icons/logo.svg')); ?>" alt="Logo"></div>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/courses.blade.php ENDPATH**/ ?>