...
<head>
    ...
    <title>{{ __('lms_ui::transactions_page.page_title') }}</title>
...
<body>
    ...
    <div class="shared-shell">
        @include('lms-ui.partials.sidebar', ['activePage' => 'transaction', 'type' => 'billing'])

        <!-- Main Content -->
        <main class="shared-content">
            <h1 class="page-title">{{ __('lms_ui::transactions_page.heading') }}</h1>
            ...
            <div class="table-card">
                ...
                <div id="transactions">
                    <table>
                        <thead>
                            <tr>
                                <th>{{ __('lms_ui::transactions_page.th_txn_id') }}</th>
                                <th>{{ __('lms_ui::transactions_page.th_invoice') }}</th>
                                <th>{{ __('lms_ui::transactions_page.th_payment_method') }}</th>
                                <th>{{ __('lms_ui::transactions_page.th_details') }}</th>
                                <th>{{ __('lms_ui::transactions_page.th_amount') }}</th>
                                <th>{{ __('lms_ui::transactions_page.th_status') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="invoice-cell">
                                        ...
                                        <div>
                                            <div class="invoice-name">{{ __('lms_ui::transactions_page.teacher_1') }}</div>
                                            <div class="invoice-sub">{{ __('lms_ui::transactions_page.course_1') }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td><a href="#" class="stripe-link">Stripe</a></td>
                                <td><span class="date-cell">{{ __('lms_ui::transactions_page.date_1') }}</span></td>
                                <td><span class="amount-cell">$9.99</span></td>
                                <td>
                                    <div class="status-cell">
                                        <span class="badge badge-paid">{{ __('lms_ui::transactions_page.paid') }}</span>
                                        <button type="button" class="btn-download active">{{ __('lms_ui::transactions_page.download') }}</button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="invoice-cell">
                                        <div class="invoice-avatar"></div>
                                        <div>
                                            <div class="invoice-name">{{ __('lms_ui::transactions_page.teacher_2') }}</div>
                                            <div class="invoice-sub">{{ __('lms_ui::transactions_page.course_2') }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td><a href="#" class="stripe-link">Stripe</a></td>
                                <td><span class="date-cell">{{ __('lms_ui::transactions_page.date_2') }}</span></td>
                                <td><span class="amount-cell">$10.00</span></td>
                                <td>
                                    <div class="status-cell">
                                        <span class="badge badge-unpaid">{{ __('lms_ui::transactions_page.unpaid') }}</span>
                                        <button type="button" class="btn-download inactive" disabled>{{ __('lms_ui::transactions_page.download') }}</button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="invoice-cell">
                                        <div class="invoice-avatar"></div>
                                        <div>
                                            <div class="invoice-name">{{ __('lms_ui::transactions_page.teacher_3') }}</div>
                                            <div class="invoice-sub">{{ __('lms_ui::transactions_page.course_3') }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td><a href="#" class="stripe-link">Stripe</a></td>
                                <td><span class="date-cell">{{ __('lms_ui::transactions_page.date_3') }}</span></td>
                                <td><span class="amount-cell">$9.99</span></td>
                                <td>
                                    <div class="status-cell">
                                        <span class="badge badge-paid">{{ __('lms_ui::transactions_page.paid') }}</span>
                ...
                <div id="refunds" style="display:none; padding: 60px; text-align: center; color: #94a3b8; font-size: 15px; font-weight: 600;">
                    {{ __('lms_ui::transactions_page.no_refunds') }}
                </div>
            </div>
        </main>
    </div>
