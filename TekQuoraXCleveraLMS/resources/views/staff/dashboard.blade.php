...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/staff-dashboard.css') }}?v={{ time() }}">
            ...
            <div class="badge-carousel-card">
                ...
                <div class="badge-track">
                    <div class="badge-item">
                        ...
                        <div class="badge-img-circle"><img src="{{ asset('assets/images/icons/4.png') }}" style="width: 32px; opacity:0.8;"></div>
                        <h4>Required 1</h4>
                    </div>
                    <div class="badge-item">
                        <p style="font-size: 10px; margin-bottom: 8px;">Master - Registration Badge</p>
                        <div class="badge-img-circle" style="background: #ecfdf5; box-shadow: 0 4px 15px rgba(209,250,229,0.5);"><img src="{{ asset('assets/images/icons/1.png') }}" style="width: 32px; opacity:0.8;"></div>
                        <h4>Required 150 Days</h4>
                    </div>
                    <div class="badge-item">
                        <p style="font-size: 10px; margin-bottom: 8px;">Newbie - Rating Badge</p>
                        <div class="badge-img-circle" style="background: #fff7ed; box-shadow: 0 4px 15px rgba(255,237,213,0.5);"><img src="{{ asset('assets/images/icons/5.png') }}" style="width: 32px; opacity:0.8;"></div>
                        <h4>Required 1</h4>
                    </div>
                    <div class="badge-item">
                        <p style="font-size: 10px; margin-bottom: 8px;">Newbie - Blog Badge</p>
                        <div class="badge-img-circle" style="background: #ede9fe; box-shadow: 0 4px 15px rgba(237,233,254,0.5);"><img src="{{ asset('assets/images/icons/8.png') }}" style="width: 32px; opacity:0.8;"></div>
                        <h4>Required 1</h4>
                    </div>
                    <div class="badge-item">
                        <p style="font-size: 10px; margin-bottom: 8px;">Newbie - Sales Badge</p>
