...
<div class="login-wrapper register-wrapper" style="margin: 40px auto;">
    <div class="login-card" style="padding: 60px 80px;">
        ...
        <h1 class="login-title" style="color: #333; font-size: 26px; margin-bottom: 40px; font-weight: 700;">Sign Up and Start Learning!</h1>
            ...
            <form action="<?php echo e(route('register.post')); ?>" method="POST" class="auth-form" id="registerForm" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>

                <!-- Role Toggle -->
                <div class="role-toggle-container">
                    <div class="role-toggle">
                        <input type="radio" id="role-learner" name="role" value="learner" <?php echo e(old('role', 'learner') === 'learner' ? 'checked' : ''); ?>>
                        <label for="role-learner" class="toggle-btn" id="label-learner">Learner</label>
                        
                        <input type="radio" id="role-guide" name="role" value="guide" <?php echo e(old('role') === 'guide' ? 'checked' : ''); ?>>
                ...
                <div class="form-actions row-actions" style="margin-top: 30px; justify-content: center; gap: 20px;">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary" style="max-width: 280px; text-decoration: none; color: #4b5563;">Cancel</a>
                </div>
            </form>

            <div class="signup-container" style="margin-top: 30px;">
                <p>Already have an Account? <a href="<?php echo e(route('login')); ?>" class="signup-link">Sign in</a></p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/register.blade.php ENDPATH**/ ?>