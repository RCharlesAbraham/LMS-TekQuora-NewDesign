...
<header class="shared-header lms-ui-header" role="banner">
    <div class="header-pill">
        <div class="header-left">
            <a href="{{ route('dashboard.1') }}" class="logo"><img src="{{ asset('assets/images/logo.png') }}" alt="Logo"></a>
            <div class="search-wrap">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                <input type="text" placeholder="{{ __('lms_ui::course_flow.search_placeholder') }}">
            </div>
        </div>
        <div class="header-right">
            @if($showIcons)
                <a href="{{ route('favorites') }}" class="h-icon-btn" title="Wishlist">
