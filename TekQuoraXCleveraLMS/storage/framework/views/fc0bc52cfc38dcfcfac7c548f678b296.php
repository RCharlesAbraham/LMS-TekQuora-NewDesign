...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ CONTENT AREA Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
        .content-header {
            margin-bottom: 24px;
        }
        ...
        /* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ AVATAR Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
        .avatar-section {
            position: relative;
            width: 100px;
            height: 100px;
...
<body>
    ...
    <div class="shared-shell">
        <?php echo $__env->make('partials.sidebar', ['activePage' => 'account'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <main class="content">
            ...
            <div class="account-card">
                ...
                <form action="<?php echo e(route('account.update')); ?>" method="POST">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="<?php echo e($user->name ?? 'Student'); ?>">
                        </div>
                        <div class="form-group">
                            <label>Username<span>*</span></label>
                            <input type="text" name="username" value="<?php echo e($user->username ?? '@Student2'); ?>">
                        </div>

                        <div class="form-group">
                            <label>Current Password<span>*</span></label>
                            <input type="password" name="current_password" value="Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢Ã¢â‚¬Â¢">
                        </div>
                        <div class="form-group">
                            <a href="<?php echo e(route('password.change')); ?>" class="btn-navy">Change</a>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="<?php echo e($user->email ?? '123@gmail.com'); ?>">
                        </div>
                        <div class="form-group">
                            <label>Date of birth<span>*</span></label>
                            <input type="text" name="dob" value="<?php echo e($user->dob ?? 'Teacher'); ?>">
                        </div>

                        <div class="form-group">
                            <label>Phone No<span>*</span></label>
                            <input type="tel" name="phone" value="<?php echo e($user->phone ?? '000-0000 0000'); ?>">
                        </div>
                        <div class="form-group">
                            <label>Country<span>*</span></label>
                            <select name="country">
                                <option <?php if(($user->country ?? 'Malaysia') == 'Malaysia'): ?> selected <?php endif; ?>>Malaysia</option>
                                <option <?php if(($user->country ?? '') == 'Thailand'): ?> selected <?php endif; ?>>Thailand</option>
                                <option <?php if(($user->country ?? '') == 'Singapore'): ?> selected <?php endif; ?>>Singapore</option>
                            </select>
                        </div>
                    </div>
                ...
                <form id="password-form" action="<?php echo e(route('account.password')); ?>" method="POST" style="display:none;"><?php echo csrf_field(); ?></form>
            </div>
        </main>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/account-new.blade.php ENDPATH**/ ?>