...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ BASKET SUMMARY Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
        .bs-items {
...
<body>
    ...
    <div class="shared-shell">
        <?php echo $__env->make('partials.sidebar', ['activePage' => 'payment', 'type' => 'billing'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div>
                    ...
                    <div class="pm-card">
                        <div class="pm-option active" onclick="selectPM(this)">
                            <img src="<?php echo e(asset('assets/images/icons/logos_stripe.png')); ?>" alt="Stripe">
                            <span>Stripe</span>
                        </div>
                        <div class="pm-option" onclick="selectPM(this)">
                            <img src="<?php echo e(asset('assets/images/icons/logos_paypal (1).png')); ?>" alt="Paypal">
                            <span>Paypal</span>
                        </div>
                ...
                <div class="footer-inner">
                    <div class="footer-logo-section">
                        <div class="logo-circle">
                            <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="IL2" style="height: 35px;">
                        </div>
                        <p class="footer-tagline">Learn anytime and anywhere from ILÂ² career skills</p>
                    </div>
                    
                    <div class="footer-links-container">
                        <div class="footer-col">
                            <a href="#">Teach on ILÂ²</a>
                            <a href="#">About Us</a>
                            <a href="#">Contact Us</a>
    ...
    <div class="modal-overlay" id="modalOverlay">
        <div class="modal-card">
            ...
            <div class="m-form">
                ...
                <div class="m-btns">
                    <button class="btn-m-pay" onclick="window.location.href='<?php echo e(route('transaction')); ?>'">Pay $11.98</button>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/payment-method.blade.php ENDPATH**/ ?>