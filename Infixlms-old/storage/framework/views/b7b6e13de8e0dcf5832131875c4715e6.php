                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="summery_pro_content">
                                                                <h5 class="font_16 f_w_700 text-nowrap m-0 theme_hover"><?php echo e(@$refund_product->product->title); ?></h5>
                                                        ...
                                                        <td>
                                                            <h5 class="font_16 f_w_500 m-0 text-nowrap"><?php echo e(__('product.qty')); ?>
                                                                ...
                                                                : <?php echo e($refund_product->return_qty); ?></h5>
                                                        </td>
                                                        <td>
                                            ...
                                            <?php else: ?>
                                                <div class="summery_lists flex-fill">
                                                    ...
                                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                                        <div
                                                            class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 ">
                                                            <h5 class="font_14 f_w_500 m-0 shipping_gatway"><?php echo e(__('product.shipping_gateway')); ?>
                                                    ...
                                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                                        <div
                                                            class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 ">
                                                            <h5 class="font_14 f_w_500 m-0 shipping_gatway"><?php echo e(__('product.address')); ?>
                ...
                <form action="<?php echo e(route('frontend.my_purchase_order_package_cancel')); ?>"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-bs-dismiss="modal"><?php echo e(__('product.Close')); ?>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\my-refund-dispute-details-page-section.blade.php ENDPATH**/ ?>