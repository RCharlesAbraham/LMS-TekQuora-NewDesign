            ...
            <div class="modal-body">
                ...
                <div class="mt-40 d-flex justify-content-between">
                    ...
                    <form id="<?php echo e(isset($form_id)?$form_id:'item_delete_form'); ?>">
                        ...
                        <input id="<?php echo e(isset($dataDeleteBtn)?$dataDeleteBtn:'dataDeleteBtn'); ?>" type="submit"
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\backend\partials\_deleteModalForAjax.blade.php ENDPATH**/ ?>