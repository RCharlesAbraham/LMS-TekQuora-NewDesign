        ...
        <div class="info-content-wrap">
            <div class="info-body">
                ...
                @elseif(request()->route('topic') == 'about')
                    ...
                    <p>ILÂ² RMUTTO was born out of a desire to make world-class education accessible. Whether you are looking to advance your career or discover a new hobby, we provide courses across all disciplines taught by industry experts.</p>
                @elseif(request()->route('topic') == 'terms')
                    <h2>Terms and Conditions</h2>
                    <p>These terms and conditions outline the rules and regulations for the use of ILÂ² RMUTTO's Website. By accessing this website we assume you accept these terms and conditions. Do not continue to use IL2 if you do not agree to take all of the terms and conditions stated on this page.</p>
                    <h2>License</h2>
                    <p>Unless otherwise stated, ILÂ² RMUTTO and/or its licensors own the intellectual property rights for all material on ILÂ² RMUTTO. All intellectual property rights are reserved. You may access this from ILÂ² RMUTTO for your own personal use subjected to restrictions set in these terms and conditions.</p>
                @elseif(request()->route('topic') == 'privacy')
                    <h2>Privacy Policy</h2>
                    <p>Your privacy is critically important to us. It is ILÂ² RMUTTO's policy to respect your privacy globally regarding any information we may collect from you across our website and applications.</p>
