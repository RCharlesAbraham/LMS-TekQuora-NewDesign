    ...
    <section class="admin-visitor-area up_st_admin_visitor white-box">
        <div class="container-fluid p-0">
            <div class="row justify-content-end  pe-4">
                ...
                <a class="primary-btn radius_30px   fix-gr-bg addIp" data-bs-toggle="modal"
                   data-bs-target="#add_new_ip" href="#" class="primary-btn small fix-gr-bg">
                    {{ __('setting.Add IP') }}
                </a>

            </div>
            <h3 class="mb-20 mt-20">{{__('setting.IP Block')}}</h3>
            <div class="col-lg-12">
