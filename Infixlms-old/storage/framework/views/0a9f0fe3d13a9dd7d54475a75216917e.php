                    ...
                    <div class="box_header common_table_header">
                        ...
                        <div class="table_btn_wrap">
                            <ul>
                                <li>
                                    <a target="_blank"
                                       href="<?php echo e(route('frontend.my_purchase_order_pdf', encrypt($order->id))); ?>"
                                       class="primary_btn downloadBtn"><?php echo e(__('product.Download Invoice')); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($package->delivery_status==4): ?>
                                                <div class="form-check">
                                                    <label class="primary_checkbox d-flex">
                                                        ...
                                                        <span
                                                            class="label_name f_w_700"><?php echo e(__('product.Is Received?')); ?></span>
                                                    </label>
                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="summery_pro_content">
                                                                <h5 class="font_16 f_w_700 text-nowrap m-0 theme_hover"><?php echo e(@$package_product->course->title); ?></h5>

                                                            </div>
                                                        </td>
                                                        <td>
                                                            <h5 class="font_16 f_w_500 m-0 text-nowrap"><?php echo e(__('product.qty')); ?>

                                                                : <?php echo e($package_product->number_of_product); ?></h5>
                                                        </td>
                                                        <td>
                                                ...
                                                <div
                                                    ...
                                                    <?php elseif($order->is_completed == 1 || $package->delivery_status >= 5): ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\Carbon\Carbon::now() <= $order->created_at->addDays(Settings('refund_times')) && $package->is_cancelled == 0 && $package->course->product->type == 2 && !$package->refundPackage && Settings('refund_status')): ?>
                                                            <a href="<?php echo e(route('refund.make_request', encrypt($package->id))); ?>"
                    ...
                    <div class="row p-3">
                        <div class="col-lg-12 col-md-12 mt_20">
                            <div class="single_input ">
                                    <span class="primary_label2"><?php echo e(__('product.reason')); ?>  <span
                                            class=""> *</span> </span>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\my-order-details-page-section.blade.php ENDPATH**/ ?>