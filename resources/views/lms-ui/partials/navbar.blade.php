    ...
    <div class="header-pill">
        <div class="header-left">
            <a href="{{ route('home') }}" class="logo">
                <img src="{{ asset('lms-ui/images/logo.png') }}" alt="Logo">
            </a>

            <a href="{{ route('lms.category') }}" class="cat-pill">
                Categories
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="m6 9 6 6 6-6"/></svg>
            </a>

            <div class="search-wrap">
                <a href="{{ route('lms.search') }}" class="search-icon-link">
        ...
        <div class="header-right">
            <a href="{{ route('lms.wishlist') }}" class="h-icon-btn {{ request()->routeIs('lms.wishlist') ? 'active' : '' }}" title="Favorites">
            ...
            <a href="{{ route('lms.shopping.cart') }}" class="h-icon-btn {{ request()->routeIs('lms.shopping.cart') ? 'active' : '' }}" title="Cart">
            ...
            <a href="{{ route('lms.account.new') }}" class="profile-pill">
