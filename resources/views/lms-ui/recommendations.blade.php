...
<head>
    ...
    <title>{{ __('lms_ui::course_flow.title_recommendations') }}</title>
            ...
            <div class="course-grid">
                ...
                <div class="c-card">
                    <div class="c-img-wrap">
                        ...
                        <img src="{{ asset('lms-ui/images/9. Animal care.jpg') }}">
                    </div>
                    <div class="c-body">
                ...
                <div class="c-card">
                    <div class="c-img-wrap">
                        <span class="badge-free">Free</span>
                        <img src="{{ asset('lms-ui/images/10. Create a startup.jpg') }}">
                    </div>
                    <div class="c-body">
                ...
                <div class="c-card">
                    <div class="c-img-wrap">
                        <span class="badge-free">Free</span>
                        <img src="{{ asset('lms-ui/images/1. Identity.png') }}">
                    </div>
                    <div class="c-body">
                ...
                <div class="c-card">
                    <div class="c-img-wrap">
                        <span class="badge-free">Free</span>
                        <img src="{{ asset('lms-ui/images/2. Relationship building digital business base.png') }}">
                    </div>
                    <div class="c-body">
