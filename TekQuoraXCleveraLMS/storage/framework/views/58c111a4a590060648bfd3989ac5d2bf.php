...
<head>
    ...
    <title><?php echo e(__('lms_ui::learning.page_title')); ?></title>
...
<body>
    ...
    <div class="shared-shell">
        <?php echo $__env->make('partials.sidebar', ['activePage' => 'learning'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <main class="content">
            <h2 class="page-title"><?php echo e(__('lms_ui::learning.page_heading')); ?></h2>
            
            <div class="main-card">
                <div class="tabs">
                    <div class="tab active"><?php echo e(__('lms_ui::learning.tab_ongoing')); ?></div>
                    <div class="tab"><?php echo e(__('lms_ui::learning.tab_completed')); ?></div>
                </div>

                <!-- <div class="grid">
                    <?php for($i = 0; $i < 4; $i++): ?>
                    <a href="<?php echo e(route('learning.p2')); ?>" style="text-decoration: none; color: inherit;">
                        <div class="course-wrap">
                            <div class="course-card">
                                ...
                                <div class="cc-img" style="background-image: url('<?php echo e(asset('assets/images/math_bg.png')); ?>');"></div>
                ...
                <?php
                    ...
                    $learningItems = __('lms_ui::learning.items');
                ?>
                <div class="grid">
                    <?php $__currentLoopData = $learningCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $item = $learningItems[$index] ?? ['date' => '', 'title' => '', 'description' => '']; ?>
                    <a href="<?php echo e($card['href']); ?>" style="text-decoration: none; color: inherit;">
                        <div class="course-wrap">
                            <div class="course-card">
                                <div class="cc-header">
                                    <span class="cc-date"><?php echo e($item['date']); ?></span>
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" stroke-width="2"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>
                                </div>
                                <div class="cc-img" style="background-image: url('<?php echo e(asset('assets/images/' . $card['img'])); ?>');"></div>
                                <div class="cc-badge"><?php echo e(__('lms_ui::learning.task_badge')); ?></div>
                                <h3 class="cc-title"><?php echo e($item['title']); ?></h3>
                                <div class="progress-bar-wrap">
                                    <div class="progress-bg"><div class="progress-fill" style="width: <?php echo e($card['progress']); ?>%;"></div></div>
                                    <span class="progress-text"><?php echo e($card['progress']); ?>%</span>
                                </div>
                                <p class="cc-desc"><?php echo e($item['description']); ?></p>
                            </div>
                        </div>
                    </a>
        ...
        <footer>
            <div class="f-brand">
                <div class="f-logo-circle"><img src="<?php echo e(asset('assets/images/icons/logo.svg')); ?>" alt="Logo"></div>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/learning.blade.php ENDPATH**/ ?>