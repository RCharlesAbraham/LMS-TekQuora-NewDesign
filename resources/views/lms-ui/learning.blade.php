...
<body>
    ...
    <div class="shared-shell">
                    ...
                    <a href="{{ route('learning.p2') }}" style="text-decoration: none; color: inherit;">
                        <div class="course-wrap">
                            <div class="course-card">
                                ...
                                <div class="cc-img" style="background-image: url('{{ asset('lms-ui/images/math_bg.png') }}');"></div>
                    ...
                    <a href="{{ $card['href'] }}" style="text-decoration: none; color: inherit;">
                        <div class="course-wrap">
                            <div class="course-card">
                                ...
                                <div class="cc-img" style="background-image: url('{{ asset('lms-ui/images/' . $card['img']) }}');"></div>
        ...
        <footer>
            <div class="f-brand">
                <div class="f-logo-circle"><img src="{{ asset('lms-ui/images/icons/logo.svg') }}" alt="Logo"></div>
