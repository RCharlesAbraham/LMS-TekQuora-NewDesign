...
<head>
    ...
    <title><?php echo e(__('lms_ui::course_flow.title_courses')); ?></title>
    ...
    <style>
        ...
        .t-avatar { width: 44px; height: 44px; border-radius: 50%; background: #f1f5f9 url('<?php echo e(asset('lms-ui/images/logo.png')); ?>') no-repeat center; background-size: contain; border: 1.5px solid #e2e8f0; }
        ...
        .hero-right .video-preview {    border: 1px solid #94a3b8; width: 100%; aspect-ratio: 1.6; background: url('<?php echo e(asset('lms-ui/images/9. Animal care.jpg')); ?>') center/cover no-repeat; border-radius: 20px; position: relative; display: flex; align-items: center; justify-content: center; }
...
<body>
    ...
    <div class="shared-shell">
        <?php echo $__env->make('lms-ui.partials.sidebar', ['activePage' => 'courses'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <main class="main-card">
            <div class="course-hero">
                <div class="hero-left">
                    ...
                    <div class="hero-btns" style="margin-top:20px;">
                        <a href="<?php echo e(route('shopping.cart')); ?>" class="btn-dark-blue" style="background: #002b55; text-decoration:none;">Add to Cart</a>
                    </div>
                </div>
            ...
            <div class="tab-strip">
                ...
                <div class="tab-item active"><?php echo e(__('lms_ui::course_flow.tab_outcomes')); ?></div>
            ...
            <div class="tab-panels">
                <div class="pane active" id="pane-outcomes">
                    <div class="outcomes-content">
                        <h2><?php echo e(__('lms_ui::course_outcomes.heading')); ?></h2>
                        <div style="font-size: 14px; color: #475569; line-height: 1.8;">
                            <p><strong><?php echo e(__('lms_ui::course_outcomes.clo1_title')); ?></strong> <?php echo e(__('lms_ui::course_outcomes.clo1_body')); ?></p>
                            <p><strong><?php echo e(__('lms_ui::course_outcomes.clo2_title')); ?></strong> <?php echo e(__('lms_ui::course_outcomes.clo2_body')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer>
            <div class="footer-inner">
                <div class="f-brand">
                    <div class="f-logo-wrap"><img src="<?php echo e(asset('lms-ui/images/icons/logo.svg')); ?>" alt="Logo"></div>
                ...
                <div class="f-right-col">
                    <form method="POST" id="courses-footer-lang" action="<?php echo e(route('locale.set', ['locale' => app()->getLocale()])); ?>" style="display:inline;">
                        <?php echo csrf_field(); ?>
                        <select class="lang-select" onchange="document.getElementById('courses-footer-lang').action='<?php echo e(url('/set-language')); ?>/'+this.value; document.getElementById('courses-footer-lang').submit();">
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/lms-ui/courses.blade.php ENDPATH**/ ?>