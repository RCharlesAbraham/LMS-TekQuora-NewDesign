                                                ...
                                                <div class="white_box style2 bg-white mb_20">
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column  ">
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">
                                                                    <?php echo e(__('product.package_code')); ?>

                                                                    : </h4>
                                                                <p class="font_14 f_w_400 m-0 lh-base">
                                                                    <?php echo e($package->package_code); ?></p>
                                                            </div>
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">
                                                                    <?php echo e(__('product.order_id')); ?>

                                                                    : </h4>
                                                                <p class="font_14 f_w_400 m-0 lh-base">
                                                                    <?php echo e(@$package->order->order_number); ?></p>
                                                            </div>
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">
                                                                    <?php echo e(__('product.seller')); ?>
                                                        ...
                                                        <div class="d-flex flex-column ">
                                                            ...
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">
                                                                    <?php echo e(__('product.order_date')); ?>

                                                                    : </h4>
                                                                <p class="font_14 f_w_400 m-0 lh-base">
                                                                    <?php echo e($package->created_at); ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex flex-column">
                                                            <?php
                                                            ...
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">
                                                                    <?php echo e(__('product.order_amount')); ?>

                                                                    : </h4>
                                                                <p class="font_14 f_w_400 m-0 lh-base">
                                                                    <?php echo e(single_price($grand_total)); ?></p>
                                                            </div>
                                                            <div class="d-flex align-items-center flex-wrap gap_5">
                                                                <h4 class="font_14 f_w_500 m-0 lh-base">
                                                                    <?php echo e(__('product.payment')); ?>
                                                    ...
                                                    <form action="<?php echo e(route('refund.refund_make_request_store')); ?>"
                                                            ...
                                                            <div class="table-responsive mb_10">
                                                                <table
                                                                    ...
                                                                    <input type="hidden" name="order_id"
                                                                           value="<?php echo e($package->order->id); ?>">
                                                                    ...
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $all_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $package_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <input type="hidden" name='e_items'
                                                                               value="<?php echo e(json_encode($e_items)); ?>">
                                                                        <input type="hidden" name='product_id'
                                                                               value="<?php echo e($package_product->packageProductDetail->course->id); ?>">
                                                                        <tr>
                                                                            <td>
                                                                                <a href="<?php echo e(courseDetailsUrl(@$package_product->packageProductDetail->course->id, @$package_product->packageProductDetail->course->type, @$package_product->packageProductDetail->course->slug)); ?>"
                                                                                   class="d-flex align-items-center gap_20 cart_thumb_div">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <h4
                                                                                            ...
                                                                                            <?php echo e(@$package_product->packageProductDetail->course->product->product_name, 30); ?>
                                                                ...
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['product_ids'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                            ...
                                                            <form action="#">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <label
                                                                            class="primary_label2 style2 "><?php echo e(__('product.additional_information')); ?></label>
                                                                        <textarea name="additional_info"
                                                                                  id="additional_info" maxlength="255"
                                                                                  placeholder="<?php echo e(__('product.additional_information')); ?>"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <label
                                                                            class="primary_label2 style2 "><?php echo e(__('product.set_prefered_option')); ?>
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            id="money_get_method">
                                                                            <option value="wallet">
                                                                                <?php echo e(__('product.wallet')); ?></option>
                                                                            <option value="bank_transfer">
                                                                                <?php echo e(__('product.bank_transfer')); ?>

                                                                            </option>
                                                                        </select>
                                                                        <div class="bank_info_div row d-none">
                                                                            <div class="col-md-12">
                                                                                <h5><?php echo e(__('product.bank_information_to_recieve_money')); ?>

                                                                                </h5>
                                                                            </div>
                                                                            <div class="col-12">
                                                                                <label
                                                                                    class="primary_label2 style2 "><?php echo e(__('product.bank_name')); ?>

                                                                                    <span>*</span></label>
                                                                                <input type="text" id="bank_name"
                                                                                       name="bank_name"
                                                                                       placeholder="<?php echo e(__('product.bank_name')); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <label
                                                                                    class="primary_label2 style2 "><?php echo e(__('product.branch_name')); ?>

                                                                                    <span>*</span></label>
                                                                                <input type="text" id="branch_name"
                                                                                       name="branch_name"
                                                                                       placeholder="<?php echo e(__('product.branch_name')); ?>"
                                                                                       class="primary_input3 style4 mb_30">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <label
                                                                                    class="primary_label2 style2 "><?php echo e(__('product.account_name')); ?>

                                                                                    <span>*</span></label>
                                                                                <input type="text"
                                                                                       id="account_name"
                                                                                       name="account_name"
                                                                                       placeholder="<?php echo e(__('product.account_name')); ?>"
                                                                                       class="primary_input3 style4 mb_30">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <label
                                                                                    class="primary_label2 style2 "><?php echo e(__('product.account_number')); ?>

                                                                                    <span>*</span></label>
                                                                                <input type="text" id="account_no"
                                                                                       name="account_no"
                                                                                       placeholder="<?php echo e(__('product.account_number')); ?>"
                                                                                       class="primary_input3 style4 mb_30">
                                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['account_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <label
                                                                            class="primary_label2 style2 "><?php echo e(__('product.set_shipment_option')); ?>
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            <option value="courier">
                                                                                <?php echo e(__('product.courier_pick_up')); ?>

                                                                            </option>
                                                                            <option value="drop_off">
                                                                                <?php echo e(__('product.drop_off')); ?></option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-lg-12">
                                                                        <div class="row shipment_info_div1">
                                                                            <div class="col-12">
                                                                                <label
                                                                                    class="primary_label2 style2 "><?php echo e(__('product.courier_address')); ?>
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = auth()->user()->customerAddresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_num => $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <option
                                                                                            ...
                                                                                            ,
                                                                                            <?php echo e(@$address->stateDetails->name); ?>

                                                                                            (<?php echo e($address->phone); ?>)
                                                                                        </option>
                                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                                </select>
                                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['pick_up_address_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="col-12">
                                                                            ...
                                                                            <input id="drop_off_courier_address"
                                                                                   ...
                                                                                   placeholder="<?php echo e(__('product.courier_address')); ?>"
                                                                                   class="primary_input3 style4 mb_30"
                                                                                   type="text">
                                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['drop_off_courier_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                    ...
                                                                    <div class="photo_uploader_lists col-lg-12">
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                <label
                                                                                    class="primary_label2 style2 "><?php echo e(__('product.image')); ?></label>
                                                                                <div
                                                            ...
                                                            <div class="d-flex justify-content-end">
                                                                <button type="submit"
                                                                        class="link_value theme_btn small_btn4"><?php echo e(__('product.send')); ?></button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
    ...
    <div class="modal fade" id="orderCancelReasonModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('frontend.my_purchase_order_package_cancel')); ?>" method="post"><?php echo csrf_field(); ?>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit"
                                class="link_value theme_btn small_btn4"><?php echo e(__('common.send')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\my-order-refund-request-page-section.blade.php ENDPATH**/ ?>