...
<head>
    ...
    <title><?php echo e(__('lms_ui::course_flow.title_recommendations')); ?> - TekQuora</title>
    ...
    <div class="shared-shell">
        ...
        <main class="shared-content main-card" style="background: #fff; border-radius: 30px; padding: 40px; box-shadow: 0 4px 25px rgba(0,0,0,0.02);">
            ...
            <div class="tab-strip">
                ...
                <div class="tab-item active"><?php echo e(__('lms_ui::course_flow.tab_recommendations')); ?></div>
            ...
            <div class="recom-header">
                ...
                <div class="c-card">
                    <div class="c-img-wrap">
                        ...
                        <img src="<?php echo e(asset('assets/images/9. Animal care.jpg')); ?>">
                    </div>
                    <div class="c-body">
                ...
                <div class="c-card">
                    <div class="c-img-wrap">
                        <span class="badge-free">Free</span>
                        <img src="<?php echo e(asset('assets/images/10. Create a startup.jpg')); ?>">
                    </div>
                    <div class="c-body">
                ...
                <div class="c-card">
                    <div class="c-img-wrap">
                        <span class="badge-free">Free</span>
                        <img src="<?php echo e(asset('assets/images/1. Identity.png')); ?>">
                    </div>
                    <div class="c-body">
                ...
                <div class="c-card">
                    <div class="c-img-wrap">
                        <span class="badge-free">Free</span>
                        <img src="<?php echo e(asset('assets/images/2. Relationship building digital business base.png')); ?>">
                    </div>
                    <div class="c-body">
        ...
        <footer>
            <div class="footer-inner">
                <div class="f-brand">
                    <div class="f-logo-circle"><img src="<?php echo e(asset('assets/images/icons/logo.svg')); ?>"></div>
                ...
                <div class="f-right-col">
                    <form method="POST" id="recom-footer-lang" action="<?php echo e(route('locale.set', ['locale' => app()->getLocale()])); ?>" style="display:inline;">
                        <?php echo csrf_field(); ?>
                        <select class="lang-picker" onchange="document.getElementById('recom-footer-lang').action='<?php echo e(url('/set-language')); ?>/'+this.value; document.getElementById('recom-footer-lang').submit();">
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/recommendations.blade.php ENDPATH**/ ?>