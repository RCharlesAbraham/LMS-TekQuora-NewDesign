...
<head>
    ...
    <title>Wishlist | ILÂ² RMUTTO</title>
...
<body>
    ...
    <div class="shared-shell">
        <?php echo $__env->make('partials.sidebar', ['activePage' => 'wishlist', 'type' => 'billing'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="main-card">
                ...
                <div id="account-pane" class="tab-pane" style="display:none;">
                    <div class="account-detail-header" style="display: flex; align-items: center; gap: 15px; margin-bottom: 40px; padding-left: 10px;">
                        ...
                        <img src="<?php echo e(asset('assets/images/icons/account details.png')); ?>" alt="Edit" style="width: 20px; height: 20px; cursor: pointer;" onclick="switchTab(null, 'payment')">
                    </div>
                ...
                <div id="payment-pane" class="tab-pane" style="display:none; padding-left: 10px;">
                    ...
                    <div style="display: flex; gap: 20px; margin-bottom: 50px;">
                        <div style="width: 110px; height: 110px; background: #f1f5f9; border-radius: 12px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
                            <img src="<?php echo e(asset('assets/images/icons/Group 108.png')); ?>" alt="PayPal" style="width: 60px; object-fit: contain;">
                        </div>
                        <div style="width: 110px; height: 110px; background: #f1f5f9; border-radius: 12px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
                            <img src="<?php echo e(asset('assets/images/icons/_x31_c1oSP_00000147916934300794265040000004632205909703336862_.png')); ?>" alt="Visa" style="width: 50px; object-fit: contain;">
                        </div>
                        <div style="width: 110px; height: 110px; background: #f1f5f9; border-radius: 12px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
                            <img src="<?php echo e(asset('assets/images/icons/Group.png')); ?>" alt="Apple Pay" style="width: 55px; object-fit: contain;">
                        </div>
                    </div>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/wishlist.blade.php ENDPATH**/ ?>