<div>
    <form action="<?php echo e(route('ebookPlanPayment')); ?>" id="orderFrom" method="post">
        <?php echo csrf_field(); ?>
        ...
        <div class="checkout_wrapper" id="mainFormData">
            ...
            <div class="billing_details_wrapper">
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <input type="hidden" name="plan_id" value="<?php echo e($cart->ebook_plan_id); ?>">
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\ebook-plan-checkout-page-section.blade.php ENDPATH**/ ?>