<div>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <input type="hidden" value="<?php echo e(route('ajaxUploadProfilePic')); ?>" id="ajax-update-profile-image">
        <input type="hidden" value="<?php echo e(url('/')); ?>" id="url">
        <div class="profilepic">
            <img class="profilepic__image" src="<?php echo e(getProfileImage($profile->image,$profile->name)); ?>"
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\student-profile-image-update.blade.php ENDPATH**/ ?>