...
<head>
    ...
    <title>{{ __('lms_ui::course_flow.title_reviews') }} - TekQuora</title>
    ...
    <div class="shared-shell">
        ...
        <main class="shared-content main-card" style="background: #fff; border-radius: 30px; padding: 40px; box-shadow: 0 4px 25px rgba(0,0,0,0.02);">
                            ...
                            <div class="t-content">
                                ...
                                <div class="t-meta" style="display: flex; gap: 15px; align-items: center; margin-top: 4px;">
                                    <span style="display: inline-flex; align-items: center; font-size: 11px; color: #94a3b8;">
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="#f59e0b" style="margin-right: 4px;"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg> {{ __('lms_ui::course_flow.ratings') }}
                                    </span>
                                    <span style="display: inline-flex; align-items: center; font-size: 11px; color: #94a3b8;">
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#64748b" stroke-width="2" style="margin-right: 4px;"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> {{ __('lms_ui::course_flow.students') }}
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="tab-strip">
                ...
                <div class="tab-item active">{{ __('lms_ui::course_flow.tab_reviews') }}</div>
            </div>

            <div class="reviews-content">
                <div class="rev-header">
                    <div class="rh-left">
                        <h2>{{ __('lms_ui::reviews_page.intro_title') }}</h2>
                        <p>{{ __('lms_ui::reviews_page.intro_text') }}</p>
                    </div>
                </div>
