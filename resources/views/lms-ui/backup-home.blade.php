        ...
        <div class="features-grid">
            <div class="feature-card">
                <div class="feature-icon" style="background: #ff8a00;">
                    <img src="{{ asset('lms-ui/images/icons/badge 1.svg') }}" alt="Great Deals"
            ...
            <div class="feature-card">
                <div class="feature-icon" style="background: #93c5fd;">
                    <img src="{{ asset('lms-ui/images/icons/video streaming 1.svg') }}" alt="Audio & Video"
                        style="width:36px;height:36px;object-fit:contain;">
                </div>
                <div>
                    <h4>Audio &amp; Video</h4>
            ...
            <div class="feature-card">
                <div class="feature-icon" style="background: #34d399;">
                    <img src="{{ asset('lms-ui/images/icons/video call 1.svg') }}" alt="Virtual Classroom"
                        style="width:36px;height:36px;object-fit:contain;">
                </div>
                <div>
            ...
            <div class="feature-card">
                <div class="feature-icon" style="background: #0d9488;">
                    <img src="{{ asset('lms-ui/images/icons/study 1.svg') }}" alt="Group learning"
                        style="width:36px;height:36px;object-fit:contain;">
                </div>
                <div>
            ...
            <div class="wide-range-left">
                ...
                <div class="wide-range-images-custom">
                    ...
                    <div class="wr-img-block wr-img-1">
                        <img src="{{ asset('lms-ui/images/learning.png') }}" alt="Learning Robotics">
                    </div>
                    <!-- Boy Image (Staggered) -->
                    <div class="wr-img-block wr-img-2">
                        <img src="{{ asset('lms-ui/images/testing1.png') }}" alt="Deep Focus">
                    </div>
                </div>
            </div>
            ...
            <div class="wide-range-right">
                <div class="category-cards-grid">
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="{{ asset('lms-ui/images/icons/007-vectors 1.svg') }}" alt="Modern Art & Ideas">
                        </div>
                        <div class="cat-text">
                            <h5>Modern</h5>
                            <p>Art &amp; Ideas</p>
                    ...
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="{{ asset('lms-ui/images/icons/Group.svg') }}" alt="Ignite Your Everyday Creativity">
                        </div>
                        <div class="cat-text">
                            <h5>Ignite Your</h5>
                    ...
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="{{ asset('lms-ui/images/icons/science 1 (1).svg') }}" alt="Electrodynamics">
                        </div>
                        <div class="cat-text">
                    ...
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="{{ asset('lms-ui/images/icons/Group (1).svg') }}" alt="Postwar Abstract Painting">
                        </div>
                        <div class="cat-text">
                            <h5>Postwar</h5>
            ...
            <div class="live-classes-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px;">
                @for($i = 0; $i < 3; $i++) <div class="free-session-card">
                    <div class="free-session-thumb">
                        <img src="{{ asset('lms-ui/images/learning.png') }}" alt="Live Class">
                    </div>
