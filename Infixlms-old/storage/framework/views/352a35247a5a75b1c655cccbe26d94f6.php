<link rel="stylesheet" href="<?php echo e(asset('Modules/Installment/Resources/assets/css/installment_verification.css')); ?>">

<div class="installment">
    <div class="container">
        <form action="<?php echo e(route('installment.submit_request')); ?>" id="installment_checkout_form" method="post"
              enctype="multipart/form-data">
            <?php echo csrf_field(); ?>

            <input type="text" hidden name="topic_id" value="<?php echo e($installmentData['topic']->id); ?>">
            <input type="text" hidden name="plan_id" value="<?php echo e($installmentData['plan']->id); ?>">
            <div class="row">
                <div class="col-12">
                    <div class="installment-card">
                        <div class="overview d-flex flex-wrap">
                            <div class="overview-left">
                                <div class="img"><img src="<?php echo e(asset($installmentData['plan']->banner)); ?>"
                                                      alt=""></div>
                            </div>
                            <div class="overview-right">
                                <h3><?php echo e(_trans('installment.Installment Overview')); ?></h3>
                                <strong>
                                    <?php echo e(@$installmentData['plan']->getTranslation('title', auth()->user()->language_code ?? 'en')); ?>

                                </strong>
                                <p><?php echo @$installmentData['plan']->getTranslation('description', auth()->user()->language_code ?? 'en'); ?></p>
                                ...
                                <div class="d-flex align-items-center flex-wrap">
                                    <span class="d-inline-block theme_btn">
                                        ...
                                        </svg><?php echo e(@$installmentData['installment_overview']['upfront']); ?>
                                    ...
                                    <span class="d-inline-block theme_btn">
                                        <svg width="31" height="31" viewBox="0 0 31 31" fill="none"
                                            ...
                                            <path d="M11.7109 22.6025H16.0768" stroke="white" stroke-width="2"
                                                  stroke-miterlimit="10" stroke-linecap="round"
                                                  stroke-linejoin="round"/>
                                        </svg><?php echo e(@$installmentData['installment_overview']['total_installment_count']); ?>

                                        <?php echo e(_trans('installment.Installments')); ?>

                                        (<?php echo e(@$installmentData['installment_overview']['total_installment_amount']); ?>)
                                    </span>
                                    <span class="d-inline-block theme_btn">
                                        <svg width="29" height="28" viewBox="0 0 29 28" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke="white" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round"/>
                                        </svg><?php echo e(@$installmentData['installment_overview']['total_payable_amount']); ?>

                                        <?php echo e(_trans('installment.Total Amount')); ?>
                                    ...
                                    <span class="d-inline-block theme_btn">
                                        <svg width="26" height="28" viewBox="0 0 26 28" fill="none"
                                            ...
                                            <path d="M8.6901 20.1941H8.7015" stroke="white" stroke-width="3"
                                                  stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg><?php echo e(@$installmentData['installment_overview']['installment_duration']); ?>

                                        <?php echo e(_trans('installment.Days Duration')); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($installmentData['plan']->verification_required == 1): ?>
                        <div class="installment-card">
                            <div class="installment-card-title">
                                <h4><?php echo e(_trans('installment.Verify Installments')); ?></h4>
                                <p>
                                    <?php echo $installmentData['plan']->verification_description; ?>

                                </p>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($installmentData['plan']->verification_banner): ?>
                                <div class="installment-card-img">
                                    <img class="verification_banner_img"
                                         src="<?php echo e(asset($installmentData['plan']->verification_banner)); ?>" alt=""
                            ...
                            <?php else: ?>
                                <div
                                    ...
                                    <div class="installment-step-card selected">
                                        <div class="icon"><img
                                                src="<?php echo e(asset('Modules/Installment/Resources/assets/images/1.png')); ?>"
                                                alt=""></div>
                                        <h5><?php echo e(_trans('installment.Select A Plan')); ?></h5>
                                    </div>
                                    <div class="installment-step-card">
                                        <div class="icon"><img
                                                src="<?php echo e(asset('Modules/Installment/Resources/assets/images/2.png')); ?>"
                                                alt=""></div>
                                        <h5><?php echo e(_trans('installment.Upload Proof')); ?></h5>
                                    </div>
                                    <div class="installment-step-card">
                                        <div class="icon"><img
                                                src="<?php echo e(asset('Modules/Installment/Resources/assets/images/3.png')); ?>"
                                                alt=""></div>
                                        <h5><?php echo e(_trans('installment.Send Proof')); ?></h5>
                                    </div>
                                    <div class="installment-step-card">
                                        <div class="icon"><img
                                                src="<?php echo e(asset('Modules/Installment/Resources/assets/images/4.png')); ?>"
                                                alt=""></div>
                                        <h5><?php echo e(_trans('installment.Get Verified')); ?></h5>
                                    </div>
                                </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($installmentData['plan']->verification_video != null): ?>
                                <div class="installment-card-video mt_30">
                                    <video class="video" controls>
                                        <source src="<?php echo e(asset($installmentData['plan']->verification_video)); ?>"
                                                type="video/mp4">
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($installmentData['plan']->request_uploads == 1 && ($installmentData['plan']->bypass_verification_for_verified_users != 1 || auth()->user()->installment_verified != 1)): ?>
                        <div class="installment-card">
                            <div class="installment-card-title">
                                <h4><?php echo e(_trans('installment.Attachments')); ?></h4>
                                <p><?php echo e(_trans('installment.Attach your documents and send them to admin')); ?></p>
                            </div>
                            <div class="attachments-box">
                                <div class="form-box mb_30">
                                    <label for="#"
                                           class="primary_label2"><?php echo e(_trans('installment.Title')); ?> <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="primary_input rounded-pill sub_attach_title"
                                           name="title[]"
                                           placeholder="<?php echo e(_trans('installment.Title')); ?> ">
                                </div>
                                <div class="form-box">
                                    <label for="#"
                                           class="primary_label2"><?php echo e(_trans('installment.Attach a file')); ?> <span
                                            class="text-danger">*</span></label>
                                    <label for="uploadImg" class="form-uploader">
                                        <input type="file" name="file[]" class="d-none file_upload sub_attach_file"
                                               id="uploadImg">
                                        <span class="show_file_name"><?php echo e(_trans('installment.Browse File')); ?></span>
                                        <a class="theme_btn rounded-pill"><?php echo e(_trans('installment.Browse')); ?></a>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="action d-flex align-items-center justify-content-end flex-wrap mt_30">
                                ...
                                <a href="#" class="theme_btn rounded-pill" id="appendMore"><i
                                    ...
                                    <?php echo e(_trans('installment.Add More Attachment')); ?></a>
                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="installment-card">
                        <h4 class="text-uppercase text-primary f_w_700"><?php echo e(_trans('installment.Installment Terms & Rules')); ?>

                        </h4>
                        <?php echo Settings('installment_terms_policy') != '0' ? Settings('installment_terms_policy') : ''; ?>


                        <div class="action d-flex align-items-center justify-content-end flex-wrap mt_30">
                            <button class="theme_btn rounded-pill" id="installment_checkout"
                                    type="button"><?php echo e(_trans('installment.Checkout')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(document).on('click', '#appendMore', function (e) {
        ...
        $('#appendAttchBox').append(
            `<div class="attachments-box">
                ...
                <div class="form-box mb_30">
                    <label for="#" class="primary_label2"><?php echo e(_trans('installment.Title')); ?></label>
                    <input type="text" name="title[]" class="primary_input rounded-pill sub_attach_title" placeholder="<?php echo e(_trans('installment.Title')); ?> ">
                </div>
                <div class="form-box">
                    <label for="#" class="primary_label2"><?php echo e(_trans('installment.Attach a file')); ?></label>
                    <label for="uploadImg_${random_num}" class="form-uploader">
                        ...
                        <span><?php echo e(_trans('installment.Browse File')); ?></span>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\installment-overview-page-section.blade.php ENDPATH**/ ?>