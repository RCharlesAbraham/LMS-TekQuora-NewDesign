<div>
    <form action="<?php echo e(route('saasPayment')); ?>" id="orderFrom" method="post">
        <?php echo csrf_field(); ?>
            ...
            <div class="order_wrapper">
                ...
                <div class="ordered_products">
                    ...
                    <div class="single_ordered_product">
                        ...
                        <span class="order_prise f_w_500 font_16">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(@$cart->plan->days==0): ?>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\saas-checkout-page-section.blade.php ENDPATH**/ ?>