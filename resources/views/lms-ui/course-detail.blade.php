...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .hero-right { flex: 0.9; }
        .video-box { 
            width: 100%; aspect-ratio: 16/10; border-radius: 25px; background: url('{{ asset('lms-ui/images/9. Animal care.jpg') }}') center/cover no-repeat;
