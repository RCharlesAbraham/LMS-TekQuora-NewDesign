                            ...
                            <form action="<?php echo e(route('update_user')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\Illuminate\Support\Facades\Auth::user()->role_id==1): ?>
                                            <div class="col-12">
                                                <div class="col-md-12 mb-25">
                                                    <label class="primary_input_label"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isModuleActive('TwoFA') && Settings('enable_two_fa')): ?>
                                            ...
                                            <div class="col-12">
                                                <div class="col-md-12 mb-25">
                                                    <label class="primary_input_label"
                                                           for="two_step_verification"><?php echo e(__('common.Two FA')); ?> </label>
                                                ...
                                                <div id="expired_time"
                                                     class="col-md-12 mb-25 <?php echo e($user->two_step_verification == 1 ? '' : 'd-none'); ?>"
                                                     style="    margin-top: 70px;">

                                                    <label class="primary_input_label"
                                                           for="two_fa_expired_time"><?php echo e(__('setting.Two FA Expired Time')); ?>
...
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\backend\changePassword.blade.php ENDPATH**/ ?>