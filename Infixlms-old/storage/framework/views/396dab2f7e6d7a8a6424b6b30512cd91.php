...
<div>
    <div class="checkout_wrapper payment_area" id="mainFormData">
                                            ...
                                            <div class="payment_method_single">
                                                <div
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gateway->method=="Stripe"): ?>
                                                        <form
                                                            action="<?php echo e(route('membership.membershipLevelUpdatePaymentSubmit')); ?>"
                                                            method="post">
        ...
        <div class="order_wrapper">
            <h3 class="font_22 f_w_700 mb_30"><?php echo e(__('frontend.Update Your Plan Level')); ?></h3>
            <div class="ordered_products">
                ...
                <div class="single_ordered_product">
                    <div class="product_name d-flex align-items-center">
                        <span><?php echo e(__('membership.Level')); ?></span>
                    </div>
                    <span class="order_prise f_w_500 font_16">
                            <?php echo e($planLevel->level->title); ?>
            ...
            <div class="ordered_products_lists">
                ...
                <div class="single_lists">
                    ...
                    <span class="totalBalance"> <?php echo e(getPriceFormat($planLevel->price)); ?></span>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\membership-level-upgrade-checkout.blade.php ENDPATH**/ ?>