...
<head>
    ...
    <title><?php echo e(__('lms_ui::course_flow.title_modules')); ?> - TekQuora</title>
    ...
    <div class="shared-shell">
        ...
        <main class="shared-content main-card" style="background: #fff; border-radius: 30px; padding: 40px; box-shadow: 0 4px 25px rgba(0,0,0,0.02); overflow: hidden;">
            ...
            <div class="tab-strip">
                ...
                <div class="tab-item active"><?php echo e(__('lms_ui::course_flow.tab_modules')); ?></div>
            ...
            <div class="modules-content">
                <div class="modules-header-info">
                    <h2><?php echo e(__('lms_ui::modules_page.intro_title')); ?></h2>
                    <p><?php echo e(__('lms_ui::modules_page.intro_text')); ?></p>
                </div>

                <div class="modules-list-outer">
                    <?php $__currentLoopData = __('lms_ui::modules_page.modules'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mod-item <?php echo e($index === 0 ? 'expanded' : ''); ?>">
                        <div class="mod-header" onclick="this.parentElement.classList.toggle('expanded')">
                            <div class="mh-left-col">
                                <h3><?php echo e($mod['title']); ?></h3>
                                <p><?php echo e($mod['hours']); ?> <?php echo e(__('lms_ui::modules_page.hours_unit')); ?> • <?php echo e(__('lms_ui::modules_page.clos_label')); ?>: <?php echo e($mod['clos']); ?></p>
                            </div>
                        ...
                        <div class="mod-expanded-content" style="display: <?php echo e($index === 0 ? 'block' : 'none'); ?>;">
                            <p class="mod-desc"><?php echo e($mod['desc']); ?></p>
                            <div class="lesson-list">
                                <div class="lesson-row"><strong><?php echo e(__('lms_ui::modules_page.row_teaching')); ?></strong> <span><?php echo e($mod['activities']); ?></span></div>
                                <div class="lesson-row"><strong><?php echo e(__('lms_ui::modules_page.row_media')); ?></strong> <span><?php echo e($mod['media']); ?></span></div>
                                <div class="lesson-row"><strong><?php echo e(__('lms_ui::modules_page.row_teacher')); ?></strong> <span><?php echo e($mod['teacher']); ?></span></div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/modules.blade.php ENDPATH**/ ?>