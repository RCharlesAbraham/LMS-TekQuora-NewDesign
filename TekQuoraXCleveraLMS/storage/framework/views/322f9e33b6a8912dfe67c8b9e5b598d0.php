...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/home.css')); ?>?v=<?php echo e(time()); ?>">
    <style>
...
<body class="home-page">
    ...
    <div class="mobile-side-nav" id="mobileSideNav">
        <div class="mobile-nav-header">
            <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo" class="logo">
    ...
    <section class="hero-section hero-step-1-wrapper">
        <div class="hero-step-1-container">
            ...
            <div class="hero-left-column">
                <img src="<?php echo e(asset('assets/images/math_bg.png')); ?>" alt="Hero Image" class="hero-img-math">
            </div>
        ...
        <div class="features-grid">
            <div class="feature-card">
                <div class="feature-icon" style="background: #ff8000;">
                    <img src="<?php echo e(asset('assets/images/icons/badge 1.svg')); ?>" alt="<?php echo e(__('lms_ui::home.feature_1_alt')); ?>">
                </div>
                <div>
            ...
            <div class="feature-card">
                <div class="feature-icon" style="background: #a2d2ff;">
                    <img src="<?php echo e(asset('assets/images/icons/video streaming 1.svg')); ?>" alt="<?php echo e(__('lms_ui::home.feature_2_alt')); ?>">
                </div>
                <div>
            ...
            <div class="feature-card">
                <div class="feature-icon" style="background: #40ffff;">
                    <img src="<?php echo e(asset('assets/images/icons/video call 1.svg')); ?>" alt="<?php echo e(__('lms_ui::home.feature_3_alt')); ?>">
                </div>
                <div>
            ...
            <div class="feature-card">
                <div class="feature-icon" style="background: #20a0a0;">
                    <img src="<?php echo e(asset('assets/images/icons/study 1.svg')); ?>" alt="<?php echo e(__('lms_ui::home.feature_4_alt')); ?>">
                </div>
                <div>
            ...
            <div class="wide-range-left">
                ...
                <div class="wide-range-images-custom">
                    ...
                    <div class="wr-img-block wr-img-1">
                        <img src="<?php echo e(asset('assets/images/learning.png')); ?>" alt="<?php echo e(__('lms_ui::home.alt_learning')); ?>">
                    </div>
                    <!-- Boy Image (Staggered) -->
                    <div class="wr-img-block wr-img-2">
                        <img src="<?php echo e(asset('assets/images/testing1.png')); ?>" alt="<?php echo e(__('lms_ui::home.alt_deep_focus')); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="wide-range-right">
                <div class="category-cards-grid">
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="<?php echo e(asset('assets/images/icons/007-vectors 1.svg')); ?>" alt="<?php echo e(__('lms_ui::home.cat_1_alt')); ?>">
                        </div>
                        <div class="cat-text">
                    ...
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="<?php echo e(asset('assets/images/icons/Group.svg')); ?>" alt="<?php echo e(__('lms_ui::home.cat_2_alt')); ?>">
                        </div>
                        <div class="cat-text">
                    ...
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="<?php echo e(asset('assets/images/icons/science 1 (1).svg')); ?>" alt="<?php echo e(__('lms_ui::home.cat_3_alt')); ?>">
                        </div>
                        <div class="cat-text">
                    ...
                    <div class="category-card-item">
                        <div class="cat-icon">
                            <img src="<?php echo e(asset('assets/images/icons/Group (1).svg')); ?>" alt="<?php echo e(__('lms_ui::home.cat_4_alt')); ?>">
                        </div>
                        <div class="cat-text">
            ...
            <div class="live-classes-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px;">
                ...
                <div class="free-session-card">
                    <div class="free-session-thumb">
                        <img src="<?php echo e(asset('assets/images/' . $course['img'])); ?>" alt="<?php echo e(__('lms_ui::home.alt_live_class')); ?>">
                    </div>
        ...
        <div class="course-cards-row" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 24px">
            ...
            <?php endif; ?>
                <div class="card-image-wrap">
                    <img src="<?php echo e(asset('assets/images/' . $course['img'])); ?>" alt="<?php echo e(__('lms_ui::home.alt_course')); ?>">
                ...
                <div class="vertical-card-body">
                    ...
                    <div class="vertical-card-footer">
                        <div class="footer-stats-wrap">
                            <img src="<?php echo e(asset('assets/images/logo.png')); ?>" class="instructor-avatar-circle" style="object-fit: contain; background: #f1f5f9; padding: 3px; border: 1px solid #e2e8f0;">
        ...
        <div class="home-footer-inner">
            <div class="footer-brand-section">
                <div class="footer-logo-circle">
                    <img src="<?php echo e(asset('assets/images/icons/logo.svg')); ?>" alt="IL2 Logo">
                </div>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/home.blade.php ENDPATH**/ ?>