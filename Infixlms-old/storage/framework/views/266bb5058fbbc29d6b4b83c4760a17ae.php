        ...
        <div class="checkout_wrapper" id="mainFormData">
                ...
                <div class="row">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isModuleActive('Store') && $is_physical > 0): ?>
                        <div class="col-lg-12 col-12 w-100 prev_billings">
                            <label class="primary_label2"><?php echo e(__('product.Shipping Methods')); ?> <span>*</span>
                            </label>
                            <select name="shipping_methods"
                                    class="mb-3 wide mb_20 w-100 shipping_methods small_select">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($shipping_methods)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $shipping_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($item->id); ?>" <?php echo e($item->id == $shipping_charge->id ? 'selected':''); ?> >
                                            <?php echo e($item->method_name); ?> <?php echo e($item->shipment_time); ?>

                                            => <?php echo e(getPriceFormat($item->cost)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                        </div>
                ...
                <div class="row billing_form" style=" <?php if(count($bills) > 0): ?> display: none <?php endif; ?>">
                    ...
                    <div class="col-lg-12 mt_20">
                        ...
                        <select id="country" name="country"
                                class="select2 mb-3 w-100" <?php echo e($errors->first('country') ? 'autofocus' : ''); ?>>
                    ...
                    <div class="col-lg-12 mt_20">
                        ...
                        <input id="address1" name="address1"
                               ...
                               onfocus="this.placeholder = ''"
                               onblur="this.placeholder = '<?php echo e(__('frontend.House Number and street address')); ?>'"
                               class="primary_input3" type="text"
                               value="<?php echo e(old('address1',!empty($current)?$current->address1:'')); ?>" <?php echo e($errors->first('address1') ? 'autofocus' : ''); ?>>
                    ...
                    <div class="col-lg-12 mt-2">
                        <input id="address2" name="address2"
                               ...
                               class="primary_input3" type="text"
                               value="<?php echo e(old('address2',!empty($current)?$current->address2:'')); ?>">
                    </div>
                    <div class="col-lg-12 mt_20 ">
                    ...
                    <div class="col-lg-12 mt_20 ">
                        ...
                        <input id="phone" name="phone" placeholder="01XXXXXXXXXX" onfocus="this.placeholder = ''"
                               ...
                               type="text"
                               value="<?php if(!empty($current)): ?><?php echo e($current->phone); ?><?php else: ?><?php echo e(!empty($profile->phone)?$profile->phone:''); ?><?php endif; ?>" <?php echo e($errors->first('phone') ? 'autofocus' : ''); ?>>
            ...
            <div class="order_wrapper">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($checkout->purchase_price > 0): ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isModuleActive('Store') && $is_physical > 0): ?>
                                <div class="single_lists">
                                    ...
                                    <span><?php echo e(getPriceFormat($shipping_charge->cost)); ?></span>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="bank_transfer">
                    <p class=" mb-2"><?php echo e(__("frontend.Your personal data will be used to process your order, support your experience throughout this website, and for other purposes described in our privacy policy")); ?>
                    ...
                    <label class="primary_checkbox d-flex align-content-between justify-content-between" for="checkbox">
                        ...
                        <span class="checkmark mr_15"></span>
                        <p class=""><?php echo e(__('frontend.By signing up, you agree to')); ?>

                            <a target="_blank"
                               href="<?php echo e(url('pages/terms')); ?>"><?php echo e(__('frontend.Terms of Service')); ?>

                                ,<?php echo e(__('frontend.Privacy Policy')); ?> </a> <?php echo e(__('frontend.and')); ?>

                            <a target="_blank" href="<?php echo e(url('privacy')); ?>"><?php echo e(__('frontend.Refund policy')); ?></a>
                        </p>

                    </label>
                    <div class="text-danger mb-2 d-none"
                         id="agreeAlert"><?php echo e(__('frontend.Please read & agree with our terms and conditions')); ?></div>
                    <button type="submit" id="submitBtn"
                            data-toggle="tooltip" data-placement="top"
                            class="theme_btn w-100 disable_btn"><?php echo e(__('frontend.Place An Order')); ?></button>
                </div>
            </div>
        </div>
    </form>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\checkout-page-section.blade.php ENDPATH**/ ?>