    ...
    <div class="login_wrapper">
        <div class="login_wrapper_left">
            ...
            <div class="login_wrapper_content">
                ...
                <p class="pb-3"><?php echo e(__('frontend.Please enter the OTP generated on your Authenticator App')); ?> <br>
                    <?php echo e(__('Ensure you submit the current one because it refreshes every 30 seconds')); ?>

                </p>
                <br><br>
                <form action="<?php echo e(route('2fa')); ?>" method="POST" id="loginForm">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any()): ?>
                                <span class="text-danger" role="alert"><?php echo e($errors->first()); ?></span>
...
<?php echo $__env->make(theme('auth.layouts.app'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\auth\google2fa.blade.php ENDPATH**/ ?>