                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="shop-details-preview">
                                <img src="<?php echo e(getCourseImage($course->product?->thumbnail)); ?>" class="w-100"
                                     alt="" id="preview-img">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($course->product?->pdf)): ?>
                                    <a href="<?php echo e(route('readSomePartOfBooks', $course->id)); ?>"
                                       class="read-some-pages-button">
                                        ...
                                        <?php echo e(__('product.Read Some Pages')); ?>

                                    </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($course->product?->product_image)): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $course->product?->product_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="shop-details-nav mt-20" id="shop-gallery">
                                        <a href="#"
                                           class="shop-details-nav-list <?php echo e($loop->first ? 'zoomGalleryActive' : ''); ?>"
                                           data-image="<?php echo e(getCourseImage($image->thumbnail)); ?>">
                                    <span><img src="<?php echo e(getCourseImage($image->thumbnail)); ?>"
                                               alt=""></span>
                                        </a>
                                    </div>
                            ...
                            <div class="shop-details-content">
                                <div class="shop-details-rating d-flex align-items-center">
                                    <div class="bg-primary text-white rounded-pill">
                                        <?php echo e(@$course->product?->category->title); ?></div>
                                ...
                                <h4 class="fw-fw-semibold"><?php echo e(@$course->title); ?></h4>
                                <div class="d-block price">
                                    <del class="fw-500 text-secondary d-block">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->product?->discount > 0): ?>
                                            <?php echo e(getPriceFormat(@$course->product?->price)); ?>

                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </del>
                                    <strong class="text-primary fw-bold">
                                        <?php echo e(storeProductPrice(@$course->product?->discount_type, $course->product?->discount, $course->product?->price)); ?>

                                    </strong>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->product->stock_manage == 1 && $course->product->stock_quantity == 0): ?>
                                        <strong class="d-block">
                                            <p class="text-warning"> <?php echo e(__('product.Out of Stock')); ?></p>
                                        </strong>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <p class="product-short-info"><?php echo $course->product?->description; ?></p>
                                <div class="product-count">
                                    <div class="nice-number">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->product_type == 2): ?>
                                ...
                                <div class="shop-details-actions">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($course->product->stock_manage==1 && $course->product->stock_quantity > 0)||$course->product->stock_manage==0): ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::check()): ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isEnrolled): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->product?->type == 1): ?>
                                                    <a href="<?php if(isset($course->product?->soft_file)): ?> <?php echo e(route('downloadVirtualFile', [$course->slug])); ?> <?php else: ?> javascript:void(0) <?php endif; ?>"
                                                       class="theme-btn bg-btn-secondary">
                                                        ...
                                                        <?php echo e(__('common.Download')); ?></a>
                                                <?php else: ?>
                                                    <a href="javascript:void(0)" class="theme-btn bg-btn-secondary">
                                                        ...
                                                        <?php echo e(__('product.Enrolled')); ?></a>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php else: ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFree): ?>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($is_cart == 1): ?>
                                                        <a href="javascript:void(0)" class="theme-btn bg-btn-secondary">
                                                            ...
                                                            <?php echo e(__('common.Added To Cart')); ?></a>
                                                    <?php else: ?>
                                                        <a href="javascript:void(0)"
                                                           class="theme-btn bg-btn-secondary addToCart">
                                                            ...
                                                            <?php echo e(__('common.Add To Cart')); ?></a>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php else: ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($is_cart == 1): ?>
                                                        <a href="javascript:void(0)" class="theme-btn bg-btn-secondary">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                       ...
                                                       class="theme-btn bg-primary buyNow">
                                                        ...
                                                        <?php echo e(__('common.Buy Now')); ?></a>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php else: ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFree): ?>
                        ...
                        <ul class="nav nav-pills rounded-0">
                            <li class="nav-item">
                                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#overview"
                                        ...
                                        aria-controls="overview"><?php echo e(__('product.Description')); ?></button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#curriculum" type="button"
                                        aria-selected="false"
                                        aria-controls="curriculum"><?php echo e(__('frontend.Additional Information')); ?></button>
                            </li>
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" href="#instructor" type="button"
                                        aria-selected="false"
                                        aria-controls="instructor"><?php echo e(__('frontend.Reviews')); ?></button>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane fade show active" role="tabpanel" id="overview">
                                <div class="shop-info-card">
                                    <p><?php echo $course->product?->description; ?></p>
                                </div>
                                    ...
                                    <div class="social_btns">
                                        ...
                                        <a target="_blank"
                                           ...
                                           class="social_btn Twitter_bg"> <i class="fab fa-twitter"></i>
                                            <?php echo e(__('frontend.Twitter')); ?></a>
                                        <a target="_blank"
                                           ...
                                           class="social_btn Pinterest_bg"> <i class="fab fa-pinterest-p"></i>
                                            <?php echo e(__('frontend.Pinterest')); ?>
                                        ...
                                        <a target="_blank"
                                           ...
                                           class="social_btn Linkedin_bg"> <i class="fab fa-linkedin-in"></i>
                                            <?php echo e(__('frontend.Linkedin')); ?>
                            ...
                            <div class="tab-pane fade" role="tabpanel" id="curriculum">
                                <div class="shop-info-card w-50">
                                    <p><?php echo @$course->product?->specification; ?></p>
                                </div>
                                <div class="shop-info-card w-50">
                                    <p><?php echo @$course->product?->faq; ?></p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="instructor" role="tabpanel">
                                <div class="shop-info-card course-rating mb-0">
                                    <h3><?php echo e(__('product.Product Rating')); ?></h3>
                                    <div class="d-flex align-items-center flex-wrap">
                                        <div class="course-rating-count text-center">
                                            <h4 class="text-primary mb-1 lh-1"><?php echo e($course->total_rating); ?></h4>
                                            ...
                                            <p class="fw-500"><?php echo e(__('product.Product Rating')); ?></p>
                                        </div>
                                        <div class="right flex-grow-1">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="fs-14">(<?php echo e(getPercentageRating($course->starWiseReview, 5)); ?>%)</span>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                                <div class="progress">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="fs-14">(<?php echo e(getPercentageRating($course->starWiseReview, 4)); ?>%)</span>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                                <div class="progress">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="fs-14">(<?php echo e(getPercentageRating($course->starWiseReview, 3)); ?>%)</span>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                                <div class="progress">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="fs-14">(<?php echo e(getPercentageRating($course->starWiseReview, 2)); ?>%)</span>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                                <div class="progress">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="fs-14">(<?php echo e(getPercentageRating($course->starWiseReview, 1)); ?>%)</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->reviews->count() < 1): ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::check() && $isEnrolled): ?>
                                                            <p class="theme_color font_16 mb-0">
                                                                <?php echo e(__('frontend.Be the first reviewer')); ?></p>
                                                        <?php else: ?>
                                                            <p class="theme_color font_16 mb-0">
                                                                <?php echo e(__('frontend.No Review found')); ?></p>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <?php else: ?>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="rating_star text-end">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::check() && Auth::user()->role_id == 3): ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if((!in_array(Auth::user()->id, $reviewer_user_ids) && $isEnrolled) || $reviewPermission > 0): ?>
                                                            <div
...
<!-- Product Details:End -->
<input type="hidden" id="stock_manage" value="<?php echo e($course->stock_manage); ?>">
<input type="hidden" id="stock_quantity" value="<?php echo e($course->stock_quantity); ?>">
    ...
    (function () {
        ...
        jQuery(document).ready(function () {
            ...
            $('.addToCart').on('click', function () {
                ...
                window.location = url + '/addToCart/<?php echo e(@$course->id); ?>/' + qty;
            });
            $('.buyNow').on('click', function () {
                var qty = $('#total_qty').val();
                window.location = url + '/buyNow/<?php echo e(@$course->id); ?>/' + qty;
            });
            $('#preview-img').ezPlus({
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\product-details-page-section.blade.php ENDPATH**/ ?>