...
<head>
    ...
    <title><?php echo e(__('lms_ui::transactions_page.page_title')); ?></title>
...
<body>
    ...
    <div class="shared-shell">
        <?php echo $__env->make('partials.sidebar', ['activePage' => 'transaction', 'type' => 'billing'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <!-- Main Content -->
        <main class="shared-content">
            <h1 class="page-title"><?php echo e(__('lms_ui::transactions_page.heading')); ?></h1>

            <div class="table-card">
                <!-- Tabs -->
                <div class="tabs-wrap">
                    <button type="button" class="tab-btn active" onclick="switchTab(this, 'transactions')"><?php echo e(__('lms_ui::transactions_page.tab_transactions')); ?></button>
                    <a href="<?php echo e(route('refund')); ?>" class="tab-btn" style="text-decoration:none; text-align:center;"><?php echo e(__('lms_ui::transactions_page.tab_refunds')); ?></a>
                </div>
                ...
                <div id="transactions">
                    <table>
                        <thead>
                            <tr>
                                <th><?php echo e(__('lms_ui::transactions_page.th_txn_id')); ?></th>
                                <th><?php echo e(__('lms_ui::transactions_page.th_invoice')); ?></th>
                                <th><?php echo e(__('lms_ui::transactions_page.th_payment_method')); ?></th>
                                <th><?php echo e(__('lms_ui::transactions_page.th_details')); ?></th>
                                <th><?php echo e(__('lms_ui::transactions_page.th_amount')); ?></th>
                                <th><?php echo e(__('lms_ui::transactions_page.th_status')); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="invoice-cell">
                                        ...
                                        <div>
                                            <div class="invoice-name"><?php echo e(__('lms_ui::transactions_page.teacher_1')); ?></div>
                                            <div class="invoice-sub"><?php echo e(__('lms_ui::transactions_page.course_1')); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td><a href="#" class="stripe-link">Stripe</a></td>
                                <td><span class="date-cell"><?php echo e(__('lms_ui::transactions_page.date_1')); ?></span></td>
                                <td><span class="amount-cell">$9.99</span></td>
                                <td>
                                    <div class="status-cell">
                                        <span class="badge badge-paid"><?php echo e(__('lms_ui::transactions_page.paid')); ?></span>
                                        <button type="button" class="btn-download active"><?php echo e(__('lms_ui::transactions_page.download')); ?></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="invoice-cell">
                                        <div class="invoice-avatar"></div>
                                        <div>
                                            <div class="invoice-name"><?php echo e(__('lms_ui::transactions_page.teacher_2')); ?></div>
                                            <div class="invoice-sub"><?php echo e(__('lms_ui::transactions_page.course_2')); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td><a href="#" class="stripe-link">Stripe</a></td>
                                <td><span class="date-cell"><?php echo e(__('lms_ui::transactions_page.date_2')); ?></span></td>
                                <td><span class="amount-cell">$10.00</span></td>
                                <td>
                                    <div class="status-cell">
                                        <span class="badge badge-unpaid"><?php echo e(__('lms_ui::transactions_page.unpaid')); ?></span>
                                        <button type="button" class="btn-download inactive" disabled><?php echo e(__('lms_ui::transactions_page.download')); ?></button>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="invoice-cell">
                                        <div class="invoice-avatar"></div>
                                        <div>
                                            <div class="invoice-name"><?php echo e(__('lms_ui::transactions_page.teacher_3')); ?></div>
                                            <div class="invoice-sub"><?php echo e(__('lms_ui::transactions_page.course_3')); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td><a href="#" class="stripe-link">Stripe</a></td>
                                <td><span class="date-cell"><?php echo e(__('lms_ui::transactions_page.date_3')); ?></span></td>
                                <td><span class="amount-cell">$9.99</span></td>
                                <td>
                                    <div class="status-cell">
                                        <span class="badge badge-paid"><?php echo e(__('lms_ui::transactions_page.paid')); ?></span>
                ...
                <div id="refunds" style="display:none; padding: 60px; text-align: center; color: #94a3b8; font-size: 15px; font-weight: 600;">
                    <?php echo e(__('lms_ui::transactions_page.no_refunds')); ?>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/transaction.blade.php ENDPATH**/ ?>