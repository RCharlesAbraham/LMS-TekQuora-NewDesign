...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/dashboard-1-responsive.css')); ?>?v=<?php echo e(time()); ?>">
    <style>
        :root {
            --primary: #003a70;
        ...
        * {
        ...
        /* ─── SIDEBAR ─── */
        .shared-sidebar {
            /* Removed style block as per instruction */
        }
...
<body>
    ...
    <div class="shared-shell">
        <?php echo $__env->make('partials.sidebar', ['activePage' => 'dashboard'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="flex-container">
                        ...
                        <div class="chart-box">
                            ...
                            <div class="bars-wrapper">
                                ...
                                <div class="bar-container">
                                    <div class="bar-actual" style="height: <?php echo e($vals[$i]); ?>%;"></div>
                                    <span class="x-label"><?php echo e($day); ?></span>
                                </div>
                ...
                <!-- <div class="side-col">
                    <div class="section-card">
                        ...
                        <a href="<?php echo e(route('course.detail')); ?>" class="course-card" style="text-decoration:none; color:inherit;">
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/dashboard-1.blade.php ENDPATH**/ ?>