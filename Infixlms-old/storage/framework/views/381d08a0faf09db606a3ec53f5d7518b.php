                                            ...
                                            <div class="payment_method_single">
                                                <div
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gateway->method=="Stripe"): ?>
                                                        <form
                                                            action="<?php echo e(route('membershipPaymentSubmit')); ?>"
                                                            method="post">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <form
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            value="Wallet"
                                                                            id="balanceInput"
                                                                            style="display: <?php echo e($user->balance >=$checkout->purchase_price?'':'none'); ?>"
                                                                            class="method"
                                                                            type="hidden">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->balance >= $checkout->purchase_price): ?>
                                                                                <button
                                                                                    class=" theme_btn"
                                                                                    type="submit">
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\membership-payment-page-section.blade.php ENDPATH**/ ?>