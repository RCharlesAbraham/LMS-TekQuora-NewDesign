                ...
                <div class="col-xl-12">
                    ...
                    <div class="account_profile_wrapper p-4">
                        <div class="account_profile_thumb text-center mb_30">
                            ...
                            <?php if (isset($component)) { $__componentOriginalacfcfd01844034130870a955c639b9f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalacfcfd01844034130870a955c639b9f6 = $attributes; } ?>
<?php $component = App\View\Components\StudentProfileImageUpdate::resolve(['profile' => $profile] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('student-profile-image-update'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\StudentProfileImageUpdate::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalacfcfd01844034130870a955c639b9f6)): ?>
<?php $attributes = $__attributesOriginalacfcfd01844034130870a955c639b9f6; ?>
<?php unset($__attributesOriginalacfcfd01844034130870a955c639b9f6); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalacfcfd01844034130870a955c639b9f6)): ?>
<?php $component = $__componentOriginalacfcfd01844034130870a955c639b9f6; ?>
<?php unset($__componentOriginalacfcfd01844034130870a955c639b9f6); ?>
<?php endif; ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 mt_20">
                                        <div class="single_input ">
                                            ...
                                            <input type="text" placeholder="<?php echo e(__('student.Phone Number')); ?>"
                                                   class="primary_input  <?php echo e(@$errors->has('phone') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <div class="col-lg-6 col-md-6 mt_20">
                                        <div class="single_input ">
                                            ...
                                            <input type="email" placeholder="<?php echo e(__('common.Email')); ?>"
                                                   class="primary_input <?php echo e(@$errors->has('email') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <div class="col-lg-6 col-md-6 mt_20">
                                        <div class="single_input ">
                                            ...
                                            <select class="theme_select wide mb_20"
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($langs)): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($custom_field->show_dob): ?>
                                        <div class="col-lg-6 col-md-6 mt_20">
                                            <div class="single_input ">
                                                <span
                                                    class="primary_label2"><?php echo e(__('common.Date of Birth')); ?> <span><?php echo e($custom_field->required_dob ? '*' : ''); ?></span> </span>
                                                <input type="date" placeholder="<?php echo e(__('common.Date of Birth')); ?>"
                                                       class="primary_input  <?php echo e(@$errors->has('dob') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($custom_field->show_gender): ?>
                                        <div class="col-lg-6 col-md-6 mt_20">
                                            <div class="single_input ">
                                                <span
                                                    class="primary_label2"><?php echo e(__('common.gender')); ?> <span><?php echo e($custom_field->required_gender ? '*' : ''); ?></span> </span>
                                                ...
                                                <select class="theme_select wide mb_20"
                                                    ...
                                                    <option data-display="<?php echo e(__('common.gender')); ?>"
                                                            value=""><?php echo e(__('common.Select')); ?></option>
                                                    <option value="male" <?php if($profile->gender=='male'): ?> selected <?php endif; ?>>
                                                        Male
                                                    </option>
                                                    <option value="female"
                                                            <?php if($profile->gender=='female'): ?> selected <?php endif; ?>>Female
                                                    </option>
                                                    <option value="other"
                                                            <?php if($profile->gender=='other'): ?> selected <?php endif; ?>>Other
                                                    </option>
                                                </select>
                                                <span class="text-danger"
                                                      role="alert"><?php echo e($errors->first('gender')); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($custom_field->show_company): ?>
                                        <div class="col-lg-6 col-md-6 mt_20">
                                            <div class="single_input ">
                                                <span
                                                    class="primary_label2"><?php echo e(__('common.Institute Name')); ?> <span><?php echo e($custom_field->required_company ? '*' : ''); ?></span> </span>
                                                <input type="text" placeholder="<?php echo e(__('common.Institute Name')); ?>"
                                                       class="primary_input  <?php echo e(@$errors->has('company_id') ? ' is-invalid' : ''); ?>"
                                                ...
                                                <span class="text-danger"
                                                      role="alert"><?php echo e($errors->first('company_id')); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($custom_field->show_student_type): ?>
                                        <div class="col-lg-6 col-md-6 mt_20">
                                            <div class="single_input ">
                                                <span
                                                    class="primary_label2"><?php echo e(__('common.student_type')); ?> <span><?php echo e($custom_field->required_student_type ? '*' : ''); ?></span> </span>
                                                ...
                                                <select class="theme_select wide mb_20" name="student_type"
                                                    ...
                                                    <option value="personal"
                                                            <?php if($profile->student_type=='personal'): ?> selected <?php endif; ?>>
                                                        Personal
                                                    </option>

                                                    <option value="corporate"
                                                            <?php if($profile->student_type=='corporate'): ?> selected <?php endif; ?>>
                                                        Corporate
                                                    </option>
                                                </select>
                                                <span class="text-danger"
                                                      role="alert"><?php echo e($errors->first('student_type')); ?></span>
                                            </div>
                                        </div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($custom_field->show_identification_number): ?>
                                        <div class="col-lg-6 col-md-6 mt_20">
                                            <div class="single_input ">
                                                <span
                                                    class="primary_label2"><?php echo e(__('common.identification_number')); ?> <span><?php echo e($custom_field->required_identification_number ? '*' : ''); ?></span> </span>
                                                <input type="text" placeholder="<?php echo e(__('common.identification_number')); ?>"
                                                       class="primary_input  <?php echo e(@$errors->has('identification_number') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($custom_field->show_job_title): ?>
                                        <div class="col-lg-6 col-md-6 mt_20">
                                            <div class="single_input ">
                                                <span
                                                    class="primary_label2"><?php echo e(__('common.job_title')); ?> <span><?php echo e($custom_field->required_job_title ? '*' : ''); ?></span> </span>
                                                <input type="text" placeholder="<?php echo e(__('common.job_title')); ?>"
                                                       class="primary_input  <?php echo e(@$errors->has('job_title') ? ' is-invalid' : ''); ?>"
                                                ...
                                                <span class="text-danger"
                                                      role="alert"><?php echo e($errors->first('job_title')); ?></span>
                                            </div>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 mt_20">
                                        <div class="single_input " id="state_div">
                                            ...
                                            <select class="  wide mb_20 stateList" name="state"
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($states)): ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 mt_20">
                                        <div class="single_input " id="city_div">
                                            ...
                                            <select class="  wide mb_20 cityList" name="city"
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($cities)): ?>
                                    ...
                                    <div class="col-lg-6 col-md-6 mt_20">
                                        <div class="single_input ">
                                            ...
                                            <input type="text" placeholder="<?php echo e(__('common.Address')); ?>"
                                                   class="primary_input <?php echo e(@$errors->has('address') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <div class="col-lg-6 col-md-6 mt_20">
                                        <div class="single_input ">
                                            ...
                                            <input type="text" placeholder="<?php echo e(__('common.Zip Code')); ?>"
                                                   class="primary_input <?php echo e(@$errors->has('zip') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isModuleActive('TwoFA') && Settings('enable_two_fa')): ?>
                                        ...
                                        <div class="col-lg-6 col-md-6 mt_20">
                                            <div class="single_input">
                                                ...
                                                <select class="select2 wide mb_20" name="two_step_verification"
                                                    ...
                                                    <option value="0"
                                                            <?php if($profile->two_step_verification == 0): ?> selected <?php endif; ?>>
                                                        <?php echo e(__('common.N/A')); ?></option>

                                                    <option value="1"
                                                            <?php if($profile->two_step_verification == 1): ?> selected <?php endif; ?>>
                                                        <?php echo e(__('common.Email')); ?></option>

                                                    <option value="2"
                                                            <?php if($profile->two_step_verification == 2): ?> selected <?php endif; ?>>
                                        ...
                                        <div
                                            class="col-lg-6 col-md-6 mt_20 <?php echo e($profile->two_step_verification == 1 ? '' : 'd-none'); ?>"
                                            id="expired_time">
                                            <div class="single_input ">
                                                        <span class="primary_label2"><?php echo e(__('setting.Two FA Expired Time')); ?>

                                                            <small>(<?php echo e(__('setting.In Minute')); ?>)</small></span>
                                                <input type="text" placeholder="<?php echo e(__('setting.Two FA Expired Time')); ?>"
                                                       class="primary_input"
                                                       name="two_fa_expired_time"
                                                       value="<?php echo e(@$profile->two_fa_expired_time); ?>"
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\my-profile-page-section.blade.php ENDPATH**/ ?>