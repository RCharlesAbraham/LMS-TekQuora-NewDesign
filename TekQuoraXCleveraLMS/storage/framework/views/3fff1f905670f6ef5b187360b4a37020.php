...
<head>
    ...
    <title><?php echo e(__('lms_ui::course_flow.title_detail')); ?></title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .avatar-circle { width: 36px; height: 36px; border-radius: 50%; background-image: url('<?php echo e(asset("images/logo.png")); ?>'); background-size: contain; background-repeat: no-repeat; background-position: center; background-color: #f1f5f9; border: 1px solid #e2e8f0; }
        ...
        .hero-right { flex: 0.9; }
        .video-box { 
            width: 100%; aspect-ratio: 16/10; border-radius: 25px; background: url('<?php echo e(asset('assets/images/9. Animal care.jpg')); ?>') center/cover no-repeat;
...
<body>
    ...
    <div class="shared-shell">
        ...
        <main class="content">
                ...
                <div class="hero-left">
                    <div class="teacher-meta">
                        <div class="t-profile">
                            ...
                            <div class="t-labels">
                                <p><?php echo e(__('lms_ui::course_flow.created_by')); ?> <span><?php echo e(__('lms_ui::course_flow.teacher')); ?></span></p>
                                <div class="t-stats-row"><span><?php echo e(__('lms_ui::course_flow.ratings_zero')); ?></span> <span><?php echo e(__('lms_ui::course_flow.students_zero')); ?></span></div>
                            </div>
                        </div>
                        <div class="t-actions-wrap">
                            <a href="#" class="btn-pill-small"><?php echo e(__('lms_ui::course_flow.save')); ?></a>
                            <a href="#" class="btn-pill-small"><?php echo e(__('lms_ui::course_flow.share')); ?></a>
                        </div>
                    </div>

                    <div class="title-row">
                        <h1><?php echo e(__('lms_ui::course_flow.course_title_vet')); ?></h1>
                        <span class="price-text"><?php echo e(__('lms_ui::course_flow.free')); ?></span>
                    </div>
                    <div class="updated-date"><?php echo e(__('lms_ui::course_flow.updated_date')); ?></div>
                    <p class="course-summary"><?php echo e(__('lms_ui::course_detail.summary_short')); ?></p>
                    <div class="dates-flex" style="display: flex; gap: 30px; font-size: 13px; color: #64748b; margin-bottom: 35px;">
                        <p><?php echo e(__('lms_ui::course_flow.course_start')); ?> <span style="color: #2563eb; font-weight: 800;"><?php echo e(__('lms_ui::course_flow.date_march_26')); ?></span></p>
                        <p><?php echo e(__('lms_ui::course_flow.course_end')); ?> <span style="color: #2563eb; font-weight: 800;"><?php echo e(__('lms_ui::course_flow.date_june_26')); ?></span></p>
                    </div>
                    <div class="btn-group">
                        <a href="<?php echo e(route('shopping.cart')); ?>" class="btn-cart"><?php echo e(__('lms_ui::course_flow.add_to_cart')); ?></a>
                    </div>
                </div>
            ...
            <!-- TABS -->
            <div class="tab-strip">
                <div class="tab-item active"><?php echo e(__('lms_ui::course_flow.tab_about')); ?></div>
                ...
                <a href="<?php echo e(route('reviews')); ?>" class="tab-item"><?php echo e(__('lms_ui::course_flow.tab_reviews')); ?></a>
            </div>
            ...
            <div class="section-container">
                <div class="content-left">
                    <div class="content-section">
                        ...
                        <p style="color: #475569; line-height: 1.8; font-size: 15px;">
                            <?php echo e(__('lms_ui::course_detail.about_long')); ?>

                        </p>
                    </div>
                    <div class="content-section">
                        <h2><?php echo e(__('lms_ui::course_detail.skills_heading')); ?></h2>
                        <ul class="learn-list">
                            <?php $__currentLoopData = __('lms_ui::course_detail.skills'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="sidebar-right">
                    <div class="about-course">
                        <h3><?php echo e(__('lms_ui::course_detail.about_course')); ?></h3>
                        <span class="course-code">34765879709809</span>
                        
                        <div class="free-banner">
                            <div class="free-text">
                                <h4><?php echo e(__('lms_ui::course_detail.free_banner_title')); ?></h4>
                                <p><?php echo e(__('lms_ui::course_detail.free_banner_desc')); ?></p>
                            </div>
                            <a href="#" class="btn-free"><?php echo e(__('lms_ui::course_flow.free')); ?></a>
                        </div>

                        <div class="feature-v-grid">
                            <div class="fv-item">
                                <img src="<?php echo e(asset('assets/images/icons/duration.png')); ?>" alt="">
                                <span class="lab"><?php echo e(__('lms_ui::course_detail.duration')); ?></span>
                                <span class="val"><?php echo e(__('lms_ui::course_detail.duration_val')); ?></span>
                            </div>
                            <div class="fv-item">
                                <img src="<?php echo e(asset('assets/images/icons/weelkly.png')); ?>" alt="">
                                <span class="lab"><?php echo e(__('lms_ui::course_detail.weekly_study')); ?></span>
                                <span class="val"><?php echo e(__('lms_ui::course_detail.weekly_val')); ?></span>
                            </div>
                            <div class="fv-item">
                                <img src="<?php echo e(asset('assets/images/icons/100%.png')); ?>" alt="">
                                <span class="lab"><?php echo e(__('lms_ui::course_detail.online_100')); ?></span>
                                <span class="val"><?php echo e(__('lms_ui::course_detail.online_val')); ?></span>
                            </div>
                            <div class="fv-item">
                                <img src="<?php echo e(asset('assets/images/icons/quiz.png')); ?>" alt="">
                                <span class="lab"><?php echo e(__('lms_ui::course_detail.quiz')); ?></span>
                                <span class="val"><?php echo e(__('lms_ui::course_detail.quiz_val')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\TekQuoraXCleveraLMS\resources\views/main/course-detail.blade.php ENDPATH**/ ?>