        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isModuleActive('CPD')): ?>
            <div class="container-fluid g-0">
                <div class="dashboard_card ">
                    <?php if (isset($component)) { $__componentOriginal4814fa3bdcbb16f88fbec3751e5ae5c8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4814fa3bdcbb16f88fbec3751e5ae5c8 = $attributes; } ?>
<?php $component = App\View\Components\CpdGraph::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cpd-graph'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\CpdGraph::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4814fa3bdcbb16f88fbec3751e5ae5c8)): ?>
<?php $attributes = $__attributesOriginal4814fa3bdcbb16f88fbec3751e5ae5c8; ?>
<?php unset($__attributesOriginal4814fa3bdcbb16f88fbec3751e5ae5c8); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal4814fa3bdcbb16f88fbec3751e5ae5c8)): ?>
<?php $component = $__componentOriginal4814fa3bdcbb16f88fbec3751e5ae5c8; ?>
<?php unset($__componentOriginal4814fa3bdcbb16f88fbec3751e5ae5c8); ?>
<?php endif; ?>
                </div>
            </div>
        ...
        <div class="container-fluid g-0">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="dashboard_title">
                        <h3><?php echo e(@$wish_string); ?>, <span><?php echo e(Auth::user()->name); ?></span></h3>
                        <p><?php echo e(@$date); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-<?php echo e($col); ?> col-12">
                    <div class="row">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(showEcommerce()): ?>
                            <div class="col-lg-<?php echo e($item); ?> col-md-4 col-sm-<?php echo e($item); ?>">
                                <div class="dashboard_card text-center">
                                    ...
                                    <span><?php echo e(__('frontend.Balance')); ?></span>
                                    <h4>
                            ...
                            <div class="col-lg-<?php echo e($item); ?> col-md-4 col-sm-<?php echo e($item); ?>">
                                <div class="dashboard_card text-center">
                                    ...
                                    <span><?php echo e(__('frontend.Total Spent')); ?></span>
                                    <h4>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($total_spent!=0): ?>
                        ...
                        <div class="col-lg-<?php echo e($item); ?> col-md-4 col-sm-<?php echo e($item); ?>">
                            <div class="dashboard_card text-center">
                                ...
                                <span><?php echo e(__('frontend.Certificates')); ?></span>
                                <h4> <?php echo e(\Illuminate\Support\Facades\Auth::user()->totalCertificate()); ?></h4>
                            </div>
                        </div>
                        <div class="col-lg-<?php echo e($item); ?> col-md-4 col-sm-<?php echo e($item); ?>">
                            <div class="dashboard_card text-center">
                                ...
                                <span><?php echo e(__('frontend.Course In Progress')); ?></span>
                                <h4> <?php echo e($total['process']); ?></h4>
                            </div>
                        </div>
                        <div class="col-lg-<?php echo e($item); ?> col-md-4 col-sm-<?php echo e($item); ?>">
                            <div class="dashboard_card text-center">
                                ...
                                <span><?php echo e(__('frontend.Course Purchased')); ?></span>
                                <h4> <?php echo e($total['total']); ?></h4>
                            </div>
                        </div>
                        <div class="col-lg-<?php echo e($item); ?> col-md-4 col-sm-<?php echo e($item); ?>">
                            <div class="dashboard_card text-center">
                                ...
                                <span><?php echo e(__('frontend.Completed Courses')); ?></span>
                                <h4><?php echo e($total['complete']); ?></h4>
                            </div>
                        </div>

                        <div class="col-12 ">
                            <div id="myHomepageCourse" class="owl-carousel">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mycourse): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $mycourse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$single_course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($key<5): ?>
                                            ...
                                            <div class="dashboard_card dashboard_banner ">
                                                <div class="thumb position-relative"
                                                     style="background-image: url('<?php echo e(getCourseImage($course->image)); ?>')"
                                                >
                                                    <span class="badge ms-3 mt-2"><?php echo e($course->courseLevel->title); ?></span>
                                                </div>
                                                <div class="banner_info">
                                                    <div class="course_qualification mb-2">
                                                        <a href="#"
                                                           class="banner_info_profile d-flex align-items-center">
                                                            ...
                                                            <p><?php echo e($course->user->name); ?></p>
                                                        </a>
                                                    ...
                                                    ?>
                                                    <a href="#" class="title"><?php echo e($course->title); ?></a>
                                                    <div class="progress">
                                                        <div
                                                            class="progress-status"
                                                            style="--position:<?php echo e($percentage); ?>%;<?php echo e($margin); ?>"
                                                    ...
                                                    <a href="<?php echo e(route('continueCourse',[$course->slug])); ?>"
                                                       class="theme_btn"><?php echo e(__('frontend.Complete This Course')); ?></a>
                                                </div>
                                            </div>
                ...
                <div class="col-xl-6 col-12">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isModuleActive('Noticeboard') && count($noticeboards)!=0): ?>

                        <div class="dashboard_card">
                            <div class="head d-flex align-items-center justify-content-between mb-4">
                                <h4><?php echo e(__('frontend.Recent')); ?> <?php echo e(__('noticeboard.Noticeboard')); ?>:</h4>
                                <a href="<?php echo e(route('myNoticeboard')); ?>"><?php echo e(__('frontend.See All')); ?></a>
                            </div>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Settings('gamification_status') && Settings('gamification_leaderboard_show_badges_status')): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $type->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="dashboard_badge_item text-center">
                                            <p><?php echo e($badge->title); ?> -
                                                <small><?php echo e(ucfirst($badge->type).' '.trans('setting.Badge')); ?></small>
                                            </p>
                                            <div class="img"><img
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\components\my-dashboard-page-section.blade.php ENDPATH**/ ?>