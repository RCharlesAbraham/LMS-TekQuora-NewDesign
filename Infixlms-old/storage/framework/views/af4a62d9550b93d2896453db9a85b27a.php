...
<?php $component = App\View\Components\Breadcrumb::resolve(['banner' => $frontendContent->course_page_banner,'title' => trans('frontend.Course Details'),'subTitle' => $course->title] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php if (isset($attributes)) { $__attributesOriginalacc2df2bb7e7e5812b41f0a6abdb659c = $attributes; } ?>
<?php $component = App\View\Components\CourseDeatilsPageSection::resolve(['course' => $course,'request' => $request,'isEnrolled' => $isEnrolled] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('course-deatils-page-section'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\CourseDeatilsPageSection::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalacc2df2bb7e7e5812b41f0a6abdb659c)): ?>
<?php $attributes = $__attributesOriginalacc2df2bb7e7e5812b41f0a6abdb659c; ?>
<?php unset($__attributesOriginalacc2df2bb7e7e5812b41f0a6abdb659c); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course->host=='VdoCipher'): ?>

        <?php echo $__env->make(theme('partials._player_modal'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php echo $__env->make(theme('layouts.master'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\pages\courseDetails.blade.php ENDPATH**/ ?>