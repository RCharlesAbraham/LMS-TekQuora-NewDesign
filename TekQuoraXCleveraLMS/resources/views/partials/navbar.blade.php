<header class="main-app-header shared-header lms-ui-header" role="banner">
    <div class="header-pill">
        ...
        <div class="header-right">
            <a href="{{ route('wishlist') }}" class="h-icon-btn {{ request()->routeIs('wishlist') ? 'active' : '' }}" title="Favorites">
            ...
            <a href="{{ route('shopping.cart') }}" class="h-icon-btn {{ request()->routeIs('shopping.cart') ? 'active' : '' }}" title="Cart">
