...
<head>
    ...
    <title>404</title>
    <link rel="stylesheet" href="<?php echo e(asset('public/backend/')); ?>/vendors/css/bootstrap.css<?php echo e(assetVersion()); ?>"/>
    <link rel="stylesheet" href="<?php echo e(asset('public/backend/')); ?>/vendors/css/themify-icons.css<?php echo e(assetVersion()); ?>"/>
    <link rel="stylesheet" href="<?php echo e(asset('public/backend/')); ?>/css/style.css<?php echo e(assetVersion()); ?>"/>
</head>
            ...
            <div class="col-lg-5 col-md-8">
                <div class="text-center">
                    <div class="logo-container">
                        <a href="#">
                            <img src="<?php echo e(asset('public/backend/img/404_Error.png')); ?>" alt="" width="100%">
                        </a>
                    </div>
                    ...
                    <div class="form-group mt-50 mb-30">
                        <a href="<?php echo e(url('/login')); ?>" class="primary-btn fix-gr-bg">
                            Back To Home
                        </a>
                    </div>
                </div>
...
<script src="<?php echo e(asset('public/backend/')); ?>/vendors/js/jquery-3.5.1.min.js"></script>
...
<?php /**PATH C:\Users\Charl\LMS-TekQuora-NewDesign\Infixlms-old\resources\views\frontend\infixlmstheme\auth\error.blade.php ENDPATH**/ ?>