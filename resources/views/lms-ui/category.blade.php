...
<head>
    ...
    <title>{{ __('lms_ui::category.page_title') }}</title>
...
<body>
    ...
    @php
        ...
        $courseTitles = __('lms_ui::category.courses');
    @endphp
    ...
    <div class="shared-shell">
        ...
        <main class="main-card">
            <div class="main-header">
                <h2>{{ __('lms_ui::category.heading_courses') }}</h2>
                <div class="sort-wrap">
                    <span class="sort-label">{{ __('lms_ui::category.sort_by') }}</span>
                    <select class="sort-select">
                        <option>{{ __('lms_ui::category.sort_default') }}</option>
                        <option>{{ __('lms_ui::category.sort_popular') }}</option>
                        <option>{{ __('lms_ui::category.sort_rated') }}</option>
                        <option>{{ __('lms_ui::category.sort_date') }}</option>
                    </select>
                </div>
            </div>
            ...
            <div class="cat-grid">
                ...
                <div class="cat-card">
                @endif
                    <img src="{{ asset('lms-ui/images/' . $img) }}" alt="{{ $title }}">
